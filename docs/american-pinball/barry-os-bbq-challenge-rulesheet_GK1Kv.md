---
title: "Barry O's BBQ Challenge Rulesheet"
discourse_topic_id: 9023
manufacturer: "American Pinball"
opdb_id: "GK1Kv"
source: https://tiltforums.com/t/barry-os-bbq-challenge-rulesheet/9023
---

# Barry O's BBQ Challenge

* [Skill Shots](#heading--skillshots)
* [Cook-Offs (Recipes)](#heading--cookoffs)
...
- **Left Saucer**: 1M + 500k + Boost **[Recipe](#heading--cookoffs)** & **[Multiball](#heading--pitmaster)** Jackpot by 500k
- **Left Ramp**: 750k + 375k + Recipe Values Boosted (at left ramp)
- **Right Orbit**: 750k + 375k + **[BOSS](#heading--boss)** Assistant (easier top lanes until BOSS or CHEF are completed)
- **Right Ramp**: 1M + 500k + **[Playfield X](#heading--playfieldx)** Time Expander (increases time for playfield X)
...
- Completing BOSS also increases bumper values by 1k each completion, but increases the value of the recipe currently being served by 300k + 50k each additional completion for the ball, and gives a BOSS award. The **[Playfield X Ramp Upgrade](#heading--playfieldx)** is always the first award, once each ball, then they are given out randomly (or in a set order on tournament mode).
...
1M is added to all FIRE hurry-ups if "FIRE Boosted" has been earned from **[left outlane skill shots](#heading--skillshots)** or completing **[Lift Off](#heading--challenges)**.
...
* Increase **[Challenge](#heading--challenges)** value – increase shot value for next mode
...
- **Ignition**: Complete BBQ PIT target banks. Awards **[Easier BBQ PIT Targets](#heading--bbqpit)** upon completion (hitting a target spots another one).
...
The base multiball jackpot is determined by the "recipe value". This is scored by hitting orange shots during **[cook-offs](#heading--cookoffs)**, and each shot made increases the multiball jackpot by the recipe value. Once Pitmaster Multiball ends, the jackpot value resets.
