---
title: "Hot Wheels Rulesheet (WIP)"
discourse_topic_id: 6633
manufacturer: "American Pinball"
opdb_id: "GEL31"
source: https://tiltforums.com/t/hot-wheels-rulesheet-wip/6633
---
...
Activating turbo boost locks in a tach value of ten times the tach value at activation for the duration of the boost, so it is better to activate at higher RPMs/tach values to maximize shot point values.
...
* (If used) Reset tilt warnings

***Treasure Hunts***
(Needing testing/verification)
To enable Treasure Hunt jackpots, players must hit all four car targets and change the insert colors to yellow.  A special sound will play and all four car targets will blink.  Hitting a car target with a blinking insert will collect a Treasure Hunt Jackpot which clears the jackpot from that target and changes the insert to solid yellow again.

Draining the ball will end the mode, and future Treasure Hunt modes require cycling through additional colors to get to yellow.
...
Collecting the checkered flag by hitting the left orbit will catch the ball on the loop magnet and finish the race.  The player's score and race completion time display on the screen before Victory Lap Multiball begins.  Players can also stack the starts of Loop Crash and Victory Lap multiballs and play both modes simultaneously as a five ball multiball.
...
The inner left loop and right orbit are alternately lit red to progress towards loop crash multiball.  The player must hit 6 lit loop shots to qualify the multiball mode, growing to a maximum of 12 loops for future mode qualifications.  The display icon showing a track loop indicates the number of shots required to qualify the mode.  Once qualified, the left orbit will light to start the three ball Loop Crash Multiball mode.  Players can stack the starts of Loop Crash and Victory Lap multiballs and play both modes simultaneously as a five ball multiball.

The player is given a 15 second ball save, and the left loop and right orbit arrows are lit red.  Hitting the left orbit, right orbit, or a pop bumper awards a "crash."  Collecting 10 crashes will light the left orbit with a green arrow to setup a super jackpot.  The super jackpot requires shooting the left orbit to catch the ball on the loop magnet, collected by knocking the ball off of the magnet with another left orbit shot before the ball is released from the magnet.  Additional super jackpot qualifications require increasing numbers of crashes.

***Track Builder Unlimited Multiball***
Players must hit the Track Builder drop target or the left saucer four times to start Track Builder Unlimited multiball.  The display icon on the left with two connecting track pieces shows a number indicating the number of hits remaining to qualify this multiball mode.  Each hit builds the base multiball jackpot value.

Once qualified, the lock insert for the left saucer will light up green; hitting the saucer starts a two ball multiball.  The game will launch a new ball into play, shooting the ball held in the left saucer onto the orange ramp as the new ball reaches the top orbit magnet, causing both balls to reach the left flipper close to the same time.  The player is given a 15 second ball save and the right saucer is lit for 15 seconds.  Hitting the right saucer before the timer runs out will add a third ball and double the base jackpot values.

Orbits and loops are lit with light blue arrows that award jackpots.  Collecting enough jackpots lights the left saucer for a super jackpot.  The ball is held in the left saucer for a few seconds after collecting a super jackpot, enabling a mega jackpot on the right kickback shot.  The mega jackpot clears and ball held in the left saucer will kick out to the orange ramp if too much time has passed after collecting the super jackpot, or the player collects the mega jackpot.

Players can repeat the super and mega jackpot qualifications, each super jackpot requires collecting additional jackpots.

***Car Chaos Multiball***
Players qualify Car Chaos Multiball after collecting 40 cars by hitting the various car standup targets.  Car Chaos Multiball starts via a Collector Case Award on the right scoop.
...
The game awards the Twin Mill hero car after the end of the Car Chaos Multiball mode.
...
In a battle, mode progress is shown on the top of the display as a green health bar that decreases as players complete objectives.  A fuel gauge to the right of the bar acts as a 90 second mode timer.  Players can add a few seconds of fuel/time by relighting BATTLE targets, with significant fuel/time added by relighting all of the BATTLE targets during the battle.

Completing the the Battle mode before fuel runs out awards a "fuel bonus" based on the remaining fuel.  Draining the ball, tilting, or running out of fuel ends and completes the current battle mode without any fuel or completion bonuses.

Mode shots are always indicated with purple, regardless of the color of the specific mode started.  Players can always start battle modes from the right saucer, or the left saucer for the first and second battle.
...
***Gorilla***
* Wave 1 - Hit each of the three front car standup targets once.  Remaining car targets are lit purple.
* Wave 2 - Hit the left and right ramp once each to light the saucers to finish the mode.  Remaining ramp shots have lit purple arrows.

Note: The ball must clear the blue ramp for Wave 2 to clear the shot requirement.  The shot is still awarded if the ball is stopped on the magnet for the 12th place/Victory Lap race start.  However, it is not awarded for the start of Loop Crash multiball.

***Triceratops (Tricera)***
The turbo kickback, right ramp, and right orbit are lit.  Completing all three shots lights the saucers to finish the mode.

***Cobras***
The left orbit, left inner loop, right ramp, and right orbit are lit.  Hitting a lit shot captures a cobra, awarding points and clearing the shot.  A cobra "escapes" every thirty seconds, causing a cleared shot to relight.  Clearing all four cobra shots simultaneously stops escapes and lights both saucers to finish the mode.

***Draven***
This Battle mode is available after completing the Gorilla, T-Rex, Cobra, and Triceratops battle modes; qualified and started through the same BATTLE light and right saucer start process.  Players are given a short ball save timer at the start of the mode.

* Wave 1 - Hit the clock tower standup target on the right saucer to light all six BATTLE target inserts
* Wave 2 - Clear any two of the BATTLE letter lights by hitting the matching standup targets
* Wave 3 - Hit any of the front three car targets
* Wave 4 - Clear two additional BATTLE letter lights by hitting the matching standup targets
* Wave 5 - Hit either of the front car targets not used to complete Wave 3
* Wave 6 - Clear the remaining two BATTLE letter lights by hitting the matching standup targets to light both saucers to finish the mode

Note: Spinners do not cycle the lit BATTLE letters during waves 2, 4, and 6.

Completing this mode awards the "Rodger Dodger" hero car if unlit and clears all five collected Battles for recollection.  Draven escapes if the player tilts or drains out of the mode, although mode completion progress is retained.  Players can continue where they left off by re-qualifying the BATTLE mode start and hitting the right saucer.

**Epic Features**
There are a total of four main Epic features (Cars, Ramps, Pops, and Loops) located to the upper right of the tach, with a central "?" for a final Ultimate Epic mini-wizard mode.  Players qualify an Epic feature by hitting the rollover switches located in the inlanes and outlines to light all four of the E-P-I-C inserts.  Pushing the left flipper button cycles the "E" and "P" lights, while the right flipper cycles the "I" and "C" lights.  Hitting the "EPIC start" or "EPIC collect" before qualifying an Epic feature will also spot a letter.
...
Players can repeat collecting the set of E-P-I-C lights to qualify additional incomplete Epic features.  Hitting the "EPIC start" stand-up begins the Epic mode for all of the currently lit features.
...
After completing all four of the main Epic features, the player can collect all four EPIC letters again to qualify the Ultimate Epic feature, indicated by the question mark in the middle of the playfield EPIC mode inserts.  The Ultimate Epic requires hitting any combination of 40 car targets, loops, pops, or ramps to light the "EPIC Complete" target.  It is possible to qualify, play, and complete all five Epic features simultaneously, including the final Ultimate Epic.

Successfully completing the Ultimate Epic feature grants the "Bone Shaker" hero car if unlit and clears all five collected Epic features for recollection.
...
When the mode time expires, the mode ends and all balls are cleared from the playfield similar to RLM.  The game clears all five of the collected hero cars for recollection, although any completed Epic features or Battles are retained.  The Special light is also lit on the kickback shot that awards a replay on default settings.