---
title: "Legends of Valhalla Rulesheet"
...
![image|311x499](upload://bvhx6p9w6WUOrJq0lDFZ0KplKPD.jpeg)

![image|333x500](upload://5CtXb19AETk3K5iI5uZ8q2qdzBJ.jpeg)
...
DWARVES = * base scoring + (Battles played * 5k) + (Legends defeated * 10k) + 25k increment
...
It differs from WAR AT SEA with more shots and no ability to continue after the super jackpot.
Left Orbit
Left Ramp
Upper Orbit Left
Upper Ramp
...
MYSTERY AWARD can add 5 RAIDERS
...
Vinland,Greenland,Iceland,Faroer,Shetland,Scandinavia,York,Dublin,Normandy,Miklagard,Kiev
Shots:
Spinner
Left Scoop
Left Orbit
...
**WAR OF THE CLANS**
Hit the blood/rage target 4 times to start this hurry up.
...
Hit the berzerker during the hurry up to get different shots (3-4 shots each set)
 ...
 **BERZERKER ATTACK**
Enable in service menu Features\Berzerker.
...
Left Ramp>Right Ramp>Center Ramp
Left loop>Left ramp
...
Awards such as 7.5 million, 10 million points, light ship locks, Add Raiders, Add Weapons, Spot a Task, Special, etc.
...
CONQUEST - collect 8 qualities of a Viking (awards 25 million)
  - FIDELITY -  1 RIGHT RAMP
  - SELF-RELIANCE - 3 BERZERKERS
  - DISCIPLINE - 25 SPINS
  - HONOR - 10 CENTER RAMPS
  -  PERSERVERENCE - BLOOD AND RAGE (TARGET HIT TWICE)
  - COURAGE - 10 LOOPS (right loop to left loop or vice versa 10 times)
  - HOSPITALITY - 5 UNDER SHIP TARGET HITS
  - TRUTH - 10 LEFT RAMPS
...
Leanan Sidhe - pink arrows (4) shots
...
Grendel - 4 ball battle. 20 sec ball save. shoot yellow arrows
...
Gwyllgi - 2 ball battle - orchid arrows
        ...
        - spinner, center ramp, right loop
        - spinner, left ramp, center ramp
...
you must collect all 9 weapons to deliver a final blow at the center ramp in order to defeat ODIN
...
![image|388x500](upload://YWDksUd3JGMYRnzcUxdeRP21ad.jpeg)

![image|388x500](upload://x8VuhZEBZSnbw2p1TPzW8GHrQRH.jpeg)