---
title: "Galactic Tank Force Rulesheet"
discourse_topic_id: 8473
manufacturer: "American Pinball"
opdb_id: "Gj6PZ"
source: https://tiltforums.com/t/galactic-tank-force-rulesheet/8473
---
...
- [Main Multiballs](#heading--multiballs)
  - [Air Strike Multiball](#heading--airstrike)
  - [Meltdown](#heading--meltdown)
  - [Cow-A-Bongo](#heading--cows)
- [Other Scoring](#heading--other)
  - [Flank Attack Targets / Shot X](#heading--flank)
  - [Quantum Accelerators / Playfield X](#heading--quantum)
  - [Plotnik's Lab](#heading--lab)
  - [Ranks](#heading--ranks)
  - [Medals](#heading--medals)
  - [Atomic Shield](#heading--shield)
  - [Lucky Break](#heading--save)
  - [Extra Balls](#heading--extraballs)
  - [End-of-Ball Bonus](#heading--bonus)
- [Wizard Modes](#heading--wizard)
  - [Tank Zulu](#heading--zulu)
  - [Ice Cream Sundae](#heading--sundae)
  - [Intergalactic Ice Cream Social](#heading--final)
...
## Layout: {#heading--layout}
## Skill Shots: {#heading--skillshots}
- Plunge the ball into the flashing LAB rollover lane to instantly qualify **[Plotnik's lab](#heading--lab)** for a mystery award.
- Plunge the ball into the flashing "advance rank" rollover lane to instantly advance in **[rank](#heading--ranks)**.
...
Defeat all 5 tanks to qualify the final battle against **[Tank Zulu](#heading--zulu)**.
...
The values for each mission shot are determined by your current **[rank](#heading--ranks)**.
...
Play all five missions to create the first **[ice cream sundae](#heading--sundae)** the galaxy has seen in centuries.
...
Air Strike Multiball is also a good time to shoot for the center **[tank targets](#heading--tanks)** thanks to the ball save given out at the start of this multiball.
...
## Other Scoring: {#heading--other}
### Flank Attack Targets / Shot X: {#heading--flank}
The far left and far right standup target banks all advance towards various game features when completed, and are often hit unintentionally during the game's various **[multiball](#heading--multiballs)** modes. Each completion of the flank attack targets advances the currently lit feature, listed clockwise, for each target bank:

- Left targets:
  - Advance **[meltdown](#heading--meltdown)**
  - Advance **[quantum accelerators](#heading--quantum)**
  - Advance bumpers

- Right targets:
  - Advance **[rank](#heading--ranks)**
  - Advance spinners
  - Advance **[cows](#heading--cows)**
...
### Ranks: {#heading--ranks}
Advancing in rank increases the **[bonus multiplier](#heading--bonus)** and the value of your lit **[mission shots](#heading--missions)**. Ranks can be advanced in several ways:

- Completing the two "advance rank" rollover lanes, or instantly awarded by making a **[skill shot](#heading--skillshots)** to the flashing one.
- Completing the right **[flank attack targets](#heading--flank)** when "advance rank" is lit.
- As a mystery award from **[Plotnik's lab](#heading--lab)**.

### Medals: {#heading--medals}
There are five medals the player can obtain by completing certain tasks in the game, listed from bottom to top:
- Complete the **[Meltdown](#heading--meltdown)**
- Start 4x scoring using the **[quantum accelerators](#heading--quantum)**
- Defeat the Juggernaut mothership during **[air strike multiball](#heading--airstrike)**
- Start **[Cow-A-Bongo](#heading--cows)**
- Attain maximum **[rank](#heading--ranks)**

All five medals must be obtained to qualify the **[final wizard mode](#heading--final)**.

### Atomic Shield: {#heading--shield}
The atomic shield between the flippers raises with every shot to the **[center target bank](#heading--tanks)** and can help prevent straight-down-the-middle drains off the targets.

### Lucky Break: {#heading--save}
Destroying any **[tank](#heading--tanks)** lights a lane under either flipper for lucky break, which will save the ball. If one lucky break is currently lit and another tank is destroyed, the other one will light.
...
## Wizard Modes: {#heading--wizard}
### Tank Zulu: {#heading--zulu}
After destroying all five **[tanks](#heading--tanks)**, the player will be able to take on the sixth tank, Tank Zulu.

### Sundae: {#heading--sundae}
Gather ingredients during all five **[missions](#heading--missions)** to combine them into the ultimate intergalactic treat.

### Intergalactic Ice Cream Social: {#heading--final}
To qualify the final wizard mode, both of the above mini-wizard modes must be completed, and all five **[medals](#heading--medals)** must be earned.