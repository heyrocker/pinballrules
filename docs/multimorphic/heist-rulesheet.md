...
**Skill Shot**: Shoot the side loop, left outer loop or left ramp.

**Crew Modes**

Your main objective is to recruit all 5 crew members pull off the Big Final Heist. Each crew member corresponds to one of the major shots. The modes are qualified by hitting the corresponding shot 1 time, then the mode is started by hitting the shot a second time. Each mode is timed. At the end of each mode, the corresponding scoop will rise up and you can collect the MacGuffin for that crew member. If you fail a mode, that character will be put in jail and will no longer be available as a mode. If you have collected enough donuts, you can bribe the police and avoid being put in jail.
...
**Demolition** - Leo Myskin. This is a 2 phase mode. Phase 1 there are 3 lit shots, left orbit, left horseshoe and right ramp, which each must be hit once. In phase 2, you must make 1 pop bumper hit. Left and right orbit will both feed the pop bumper area.
...
In the first phase of the heist, there will be one shot lit corresponding to each member of the crew working the job. Hitting the crew member shot twice will add a ball, when all shots made you progress to the second phase. Second phase is hit the scoop to collect the jewel within the timer. Failing the heist will put Maggie into Jail.
...
* **Pick n Roll** (Safecracker). Shoot the ball under the upper right flipper and catch it.

*  **Grappling Hook** (Cat Burglar). Crane will suspend the ball near the upper right flipper, hit it off the crane at the right time with the flipper to shoot the cross town loop.
...
Police multiball contains several phases of increasing value. Phase 1. The left horseshoe and right horseshoe are lit for jackpots. Once you hit both jackpots, the jail will be lit for Advance, increasing the jackpot and moving to the next phase. Phase 2 the ramps are lit for jackpots. Phase 3 the orbits are lit for jackpots.

**The Big Heist**

Collect all crew members (including Mastermind) to start the Big Final Heist will be lit in the Jail.

There is one phase for each character. The first 3 phases (Wheelman, Hacker and Demolition) occur in the order you qualified the characters. If you earned the MacGuffin for the character, it will assist you in the mode. Failing a phase will arrest the associated character. But if you break them out, you can restart the BFH.
...
**Cat Burglar.** In this mode the scoop walls will be raised. Step 1, you have 15 seconds to hit the crane, and then the scoop wall will open and you have 10 seconds to shoot the scoop. In step 2, the ball will feed to your flipper, a scoop will open and you one chance to shoot the open scoop (well, actually there is a small grace period you might get a second chance). Once you complete 4 shots you complete the mode. The MacGuffin will drop more walls, giving you a larger target to shoot.

**Safe Cracker.** Step 1, you need to make 6 shots (? if you have the MacGuffin). There is a 15 second timer, that resets whenever you have a shot. In step 2, you need to hit the side loop. You can feed the shot at the upper flipper by hitting any of the shots that can capture the ball (anything by right ramp). After making the side loop, the jail will open and shoot the jail to finish the stage.

**15 Car Monte** This is a 15 ball multiball that lasts 60 seconds and done not finish when you drain down to 1 ball. There are 5 shots to hit. Once they are complete, the side loop is lit for the final shot. Completing this shot will finish the game. If you fail, all 6 members of the crew will be put in jail.
...
* Donuts: Move the donuts using the secondary buttons. Collect 6 donuts to increase bonus X. 12 donuts for a police bribe (The next arrested character will instead be set free).