---
title: "Winchester Mystery House Rulesheet"
discourse_topic_id: 10143
manufacturer: "Barrels of Fun"
opdb_id: "GvBzO"
source: https://tiltforums.com/t/winchester-mystery-house-rulesheet/10143
---

# Winchester Mystery House

_Last updated for code revision: 2026.07.01_

[**Overview**](#heading--overview)
[**Skill Shots and Drop Targets**](#heading--skill)

[**Navigating the Mansion**](#heading--mainplay)
- [Selecting a Room](#heading--tour)
- [Traveling](#heading--travel)
- [Outside the Door](#heading--modes)
- [Running](#heading--running)

[**Modes/Rooms:**](#heading--roomindex)

- [Foyer](#heading--room-foyer)
- [Twin Dining Rooms / Mirror Banquet](#heading--room-twin)
- [Kitchen / The Hungering Flame](#heading--room-kitchen)
- [Venetian Dining Room / Flicker and Flame](#heading--room-venetian)
- [Basement / Whispers in the Dark](#heading--room-basement)
- [Seance Room / The Thirteenth Toll](#heading--room-seance)
- [Daisy Bedroom / Lullaby of the Hollow Eyes](#heading--room-daisy)
- [Daisy Bedroom / The Shattered Threshold](#heading--room-daisy2)
- Grand Ballroom / Echoes
...
- [Spirit Ambush](#heading--spirit-ambush)
...
- [Summons / Summon the Mortals](#heading--13-summons)
- [Webs / Spider Web Frenzy](#heading--13-webs)
- [Targets / Virtuoso](#heading--13-targets)
- [Loops / Neverending Halls](#heading--13-loops)
- [Combos / Banished](#heading--13-combos)
- [Thirteenths Mini Wizard Mode](#heading--13-wiz)

[**Echoes**](#heading--echoes)
...
### Running {#heading--running}
During your travels, you may hold down the action button to run. Running has two primary uses:

- Sprint during the travel phase to the next room
- Avoiding angry spirits in the hallway (skipping the encounter but potentially taking a penalty - see [**Angry Spirits**](#heading--angry)).

The game begins with Run ready (status will be shown in the upper right of the screen if you have it ready and it is usable, or it is depleted). After using Run, you must hit a progressively increasing number of switches to qualify it again. So, use your run carefully! (Note: there are settings in the operator menu that control when/how run is qualified, so be sure to review those to make it easier/harder to run).
...
Maribel won’t wait forever though - you need to hit the matching shot quickly, or things will get sour (and atonal… and creepy).
...
Visiting the Daisy bedroom after Echoes gives a completely different experience - angry spirits are pouring in from somewhere else, you need to stop them by creating three barriers of salt to stop them from crossing the threshold.

Start by hitting the white shot lit at the spinner, followed by hitting any other white shots that spawn afterwards. Angry spirits will be entering the room trying to stop you, expel them by hitting red shots as they appear.
...
You may [**Run**](#heading--running) from a Spirit Battle, and if you do so, you will lose 5 million of room value and continue travel to the next room.

### Spirit Ambush {#heading--spirit-ambush}
Spirit Ambush can happen at any time when traveling the halls from your second room onward. You will know that the spirit ambush is happening as the music will change, the playfield will light a red hue, and a red shot will light. Hit the red shot to start the Ambush.

You will be attacked in an untimed battle against 3 spirits. As the ball is returned to you, a shot will light blue and red. Hitting the blue shot in the first few seconds will double the value of expelling the spirit at the red shot. Hit the red shot to expel a spirit and get a significant scoring value.
...
### Spirit Reckoning {#heading--spirit-reckoning}
Spirit Reckonings occur as soon as possible if there are three angry spirits in the house. Should this happen, you will be forced to start the Reckoning before advancing on in the game. The mechanics of playing Spirit Reckoning appear to be identical to the Spirit Ambush.

It's worth noting that if you get a Spirit Reckoning, your next "planned" Ambush is removed. For example, if you're playing a multiplayer game, and it's established that room 4 is when Ambush will happen. If a player were to play and fail 3 modes, they would immediately be put in to a Reckoning, and the Ambush that would have happened on the 4th room is removed. The spirits are angry, but they do appear to have some sense of fairness.

You can [**Run**](#heading--running) from a Spirit Reckoning, which will remove you from being trapped, but will be unable to earn points or collect the [**Wildcard Memento**](#heading--mementos) from completing the reckoning.
...
### Loops {#heading--13-loops}
Hitting the inner loop adds to the total

Mode: Summon the Mortals

### Combos {#heading--13-combos}
Combing shots adds to the total

Mode: Banished

### Thirteenths {#heading--13-wiz}
...
## Echoes {#heading--echoes}
Collect three mementos and immediately you will be taken to the Grand Ballroom, where friendly spirits are playing the organ. Shoot any cyan shot to start Echoes.

Echoes has three phases:

#### Phase 1: Expel Spirits and Escape the Basement

When Echoes starts, you will have a number of red shots at a minimum to collect, and a generous ball save period. You will have a base of 2 shots red, and one additional red shot for any angry spirits in the house at the time of starting echoes. Collect each shot to neutralize an angry spirit, starting at 13m and going up by 1m each subsequent shot. When all shots have been hit, the hallway will turn and light the spinner cyan for the final shot of the mode to the Stairs to Nowhere and advance to the next phase. If you do not collect it, the hall will rotate to make the center hall divert to the Stairs instead (at a lower value).

During this phase, you will notice the ball save lit red, and your ball will be returned. After some time, the ball save will instead turn yellow. Draining during the yellow ball save will end phase 1 and advance to the next phase.

#### Phase 2: Building the Escape

After you exit the basement, you’ll be greeted with a 2 ball multiball phase, and more angry spirits.

To advance in this phase, you must hit any blue shot to light the Door to Nowhere ramp red. You will need to feed the upper right flipper to make the shot: during this phase, the center hallway shot in the turntable will feed to the right flipper. Hitting this shot will give you an audio cue (a la Whitewater) that the ball is coming to the upper right flipper. Hitting the red shot will then light the right ramp for Super Jackpot. These are unlimited until the red dot on the map makes its way to the Grand Ballroom, at which time, shots will light blue and the cycle will begin again.

When you drain down to once ball, you will enter the final phase.

#### Phase 3: Escape

When you are down to your final ball of Phase 2, phase three will begin. This phase is a single shot to the right ramp and behind the tower to escape the angry spirits. Your value will be a cumulation of points earned through Phase 2 of Echoes. Hitting any switch OTHER than the right ramp will decrease this value, so be sure to hit the right ramp and escape as soon as possible!
...
## Mini-Modes {#heading--mini}
At present, the game has two miniature scoring modes that can pop up when certain conditions are met. These modes appear to be stackable with most other activities in the house.

### Spirit Spinner
Spirit spinner is an award for "super saturating" the spinner. To qualify, you must hit a lit spinner (spinner lights by hitting a ramp) when the spirit meter is already full. Spirit spinner will start and award "super spinner" like points for subsequent spinner shots during this time. Points are awarded "as you go", and can get quite lucrative with a set of good spinner rips.

### Stair Madness
Stair madness is a bank-and-collect frenzy that starts after your third right ramp of the game (subsequent Stair Madnesses in the same game require 4 shots). While stair madness is running, switch hits build the value of the bank shown in the lower left of the display. The shot is then cashed out at the right ramp. The cashout can be multiplied by hitting the right ramp as part of these combos:

- **2x cashout**: Left Ramp -> Right Ramp
- **4x cashout**: Center/Side Ramp -> Left Ramp -> Right Ramp

Subsequent Stair Madness will receive a scoring boost if the prior one was successfully cashed out, but will be brought to base if one is not cashed out. Cashing out 3 Stair Madnesses in one game will light the captive ball for a wildcard memento.
...
- Successfully completing Spirit Ambush or Spirit Reckoning
...
- Twin Dining Rooms - Mirrored Teaspoon
    - Perk: Fill Spirit Energy Meter (one time)
...
- Daisy Bedroom (pre-Echoes) - Porcelain Locket
    - Perk: +5m base mode value (permanent)
- Daisy Bedroom (post-Echoes) - Music Box
    - Perk: +5x to Bonus Multiplier (permanent)
- Basement - Boiler Gauge Dial
    - Perk: Spirit Energy Jackpot Collect Timer +13 seconds (permanent)
- Seance Room - Spirit Board
    - Perk: Spirit Spinner Timer & Stair Madness Timer +13 seconds (permanent)
- Sarah's Bedroom - House Key Charm
    - Perk: +5 keys
