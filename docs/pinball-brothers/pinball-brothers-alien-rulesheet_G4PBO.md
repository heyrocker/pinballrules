---
title: "Pinball Brothers Alien Rulesheet"
discourse_topic_id: 7966
manufacturer: "Heighway Pinball/Pinball Brothers"
opdb_id: "G4PBO"
source: https://tiltforums.com/t/pinball-brothers-alien-rulesheet/7966
---
...
- Complete DROP and SHIP at the ramps for 2x scoring.
...
- *Left / Right Orbit*: TBD
- *Left / Right Ramp*: Spots all **[DROP or SHIP letters](#heading--dropship)**
- *Any Weapon Target*: Awards the next **[Weapon](#heading--weapons)**
- *Xenomorph Target*: **[2 Xenomorph hits](#heading--ambush)**
- *Host Target*: TBD
...
- **Tunnel Hunt**: Shoot the 3 Vents once each - the left eject, the right lane, and the upper loop - to light the Air Lock to win the mission. The value of the Air Lock is doubled if Vents 1, 2, and 3 are made in the correct order prior to shooting it.
...
- **Queen's Nest**: Alternate shots between either orbit (which feed the bumpers during this mission) and the Air Lock. Complete this sequence 3 times to finish off the Alien Queen and win the mission. Scoring during this mission is determined by the number of **[eggs](#heading--eggs)** that were destroyed beforehand.
...
- *Facehugger* - Vents 1, 2, or 3
- *Chestburster* - Host target / magnet
- *Xenomorph* - Xenomorph targets

On the final shot, Save Newt Multiball will start (taking precedence over any progress towards **[Ambush Multiball](#heading--ambush)** to prevent the two from stacking). This is a complex 4-ball multiball split into three different phases:

- *Phase 1* - Shoot the red flashing shots to use the plasma cutter. Each shot during this phase scores a 1x jackpot and increases the base jackpot value for the remainder of the multiball. After about 30 seconds, Newt will be abducted and must be rescued.
- *Phase 2* - Shoot either Vent 1, 2, or 3 to rescue Newt. The correct vent is randomly determined each time the multiball is started. Incorrect shots score 1x the jackpot value, the correct shot scores 2x the jackpot value and increases it.
...
- Winning any **[mission](#heading--missions)**
- **[MU/TH/UR Mystery](#heading--mystery)**
...
- Time added (during a **[mission](#heading--missions)** or **[2x scoring](#heading--dropship)**)
- Add-a-ball (during any **[multiball mode](#heading--multiballs)**)
- Light **[hypersleep lock](#heading--hypersleep)**
- Advance **[lifecycle](#heading--savenewt)**
- +1 **[Weapon](#heading--weapons)**
- Start **[2x scoring](#heading--dropship)**
- **[+2x bonus multiplier](#heading--bonus)**
- Increase **[combo](#heading--combos)** values
...
- **Chestburster Combo**: After a ball is held on the Host magnet, either via a direct hit or by rolling through it via the bumpers, shoot Vent 3 to score a Chestburster Combo. Every 3 Chestburster Combos holds over a minor scoring value that would otherwise reset at the end of the ball.
...
- Collecting all 5 **[Weapons](#heading--weapons)**
- Rare **[mystery award](#heading--mystery)**
...
- Total **[eggs destroyed](#heading--eggs)**
...
- Phase 1 - Shoot the left orbit, left ramp, right ramp, and right orbit to evacuate the ship. After making all four shots, shoot the Air Lock to finish the phase.
- Phase 2 - Shoot any of the Xenomorph targets, then drive off the alien for good by shooting the Air Lock.
- Phase 3 - Shoot Vent 1 to ignite the ship's engine, flee with your life, and successfully win the wizard mode.
...
- Phase 1 - Shoot the left orbit, any Xenomorph target, and the right orbit once each to attack the Queen.
- Phase 2 - Shoot Vent 1 to lure the Queen, then shoot the Air Lock to push the Queen into the airlock.
- Phase 3 - Make four ramp shots to escape, then shoot the Air Lock to kill the Queen, successfully winning the wizard mode.
...
- *Bumpers* - value based on how many **[eggs](#heading--eggs)** were destroyed
- *Xenomorph targets* - value based on the number of completed **[lifecycles](#heading--savenewt)**
- *Weapon standup targets* - value based on the number of collected **[weapons](#heading--weapons)**
- *Ramps* - worth the highest **[combo](#heading--combos)** value collected this game
- *Vents* - worth the most recent **[Save Newt Multiball](#heading--savenewt)** jackpot value
- *Host target / magnet* - worth the most recent **[Ambush Multiball](#heading--ambush)** jackpot value
- *Orbits* - worth the most recent **[Sentry Guns Multiball](#heading--sentryguns)** jackpot value
- *APC drop targets* - worth the most recent **[Hypersleep Multiball](#heading--hypersleep)** jackpot value

During the multiball, along with scoring all the points described above, you can score even more by completing any of the following shot sequences...

- Making a shot to Vents 1, 2, *and* 3 scores a super jackpot determined by how well you did during **[missions](#heading--missions)**.
- Shooting both orbits, both ramps, the Air Lock, and the Xenomorph target increases the scoring multiplier for the wizard mode by +1x.
- Shooting all the Weapon standup targets adds a ball into play.

All-Out War ends once the player returns to single-ball play. Multiball progress at this point is remembered, so if you were to start a second All-Out War in the same game, you would "just" need to play all 10 missions to start it.