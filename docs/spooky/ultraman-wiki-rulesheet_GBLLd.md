---
title: "Ultraman Wiki Rulesheet"
discourse_topic_id: 7456
...
**Neronga (Expert):** Neronga is the second expert mode added to the game. This mode is all about protecting Tokyo's power system from the giant kaiju. The lightshow at the beginning of the mode will help highlight the different areas of the playfield. Each of these areas represents a different section of Toykyo. Neronga will always be draining power from one of these sections. Shooting shots in these sections will help restore power. Maintain a high power lever across the entire playfield for maximum scoring. 

Every so often the drop targets will rise, representing an attack from Neronga. While attacking all power drains will be doubled. Clearing the drop targets slow the power drain and score the remaining hurry-up value. After three attacks the crossing shot on the upper playfield will be lit to collect a Super Jackpot...ending the mode. Players can stay in the mode as long as they want, but the speed of the power drain will increase after each attack. 

This mode is qualified by collecting a minimum of three Science Patrol Assists. More assists can be collected prior to starting the mode and for every assist you collect will be rewarded with the ability to bring sections of the playfield back on line after it is offline. If available, these shots will be lit orange on the playfield.  
