---
title: "Looney Tunes Rulesheet"
discourse_topic_id: 9499
manufacturer: "Spooky Pinball"
opdb_id: "GJ2K0"
source: https://tiltforums.com/t/looney-tunes-rulesheet/9499
---

# Looney Tunes
[Official Rulesheet](https://www.spookypinball.com/wp-content/uploads/2024/12/Looney-Tunes-Rule.pdf)
...
- Original Wiki Rulesheet hosted on [Tilt Forums](/spooky/looney-tunes-rulesheet_GJ2K0)
...
- **Rabbit Punch** (1948): (*This mode requires all three **[combo jackpots](#heading--combos)** at the right ramp to have been earned before it can be started.*) Bugs and the Crusher fight in a no-holds-barred boxing / wrestling match with Bugs employing his own unusual tactics. This mode begins with an add-a-ball and all shots lit to deal damage, with combos boosting scoring. The final knockout blow will be lit at the right ramp.
...
Hitting the crate also lights a random red arrow shot. Collecting these red arrows will fill up the tornado lightstrip on the backboard and eventually start **[Taz-Mania](#heading--taz)** mini-wizard mode.

[details="ACME Factory Catalog"]
|**Item Name**|**Boost**|**Criteria**|
| --- | --- | --- |
|**Hare Restorer**|Light **[outlane ball saves](#heading--ballsave)**|N/A|
|**Iron Carrot**|10x carrot targets|N/A|
|**Giant Slingshot**|10x slingshot values|N/A|
|**Dynamite**|**[Captive ball hits](#heading--rocket)** doubled|N/A|
...
|**Anvil**|Start **[anvil hurry-up](#heading--anvil)**|N/A|
|**Radar Gun**|**[+75 MPH](#heading--roadrunner)**|Must be on ball 1 or 2|
|**Extendo-Punch**|5x **[combo](#heading--combos)** values|Make a 3-way combo|
|**Rocket Powered Skates**|3x orbit values|Play **[giant rocket multiball](#heading--rocket)**|
|**Martian Capsule**|3x spinner value|Start **[Instant Martians](#heading--area5134)**|
|**Integrating Pistol**|Light ball save|Start **[Planet X](#heading--area5134)**|
|**Martian Bomb**|Spot all lit shots|Start all **[Marvin modes](#heading--area5134)**|
|**Blueprint**|**[+1x playfield X](#heading--pfx)**|Open 1 crate|
|**Vault Access Card**|Light **[start episode](#heading--modes)**|Open 1 crate|
|**Tornado-In-A-Can**|Advance **[Taz-Mania](#heading--taz)** meter|Open 2 crates|
|**Bat-Man Outfit**|Light **[Roadrunner Jackpot](#heading--roadrunner)**|Open 2 crates|
|**Giant Magnet**|Light **[extra ball](#heading--extraballs)**|Open 3 crates|
...
- Collecting & using the **giant magnet** **[item](#heading--items)**
- Getting the **[Roadrunner's speed](#heading--roadrunner)** to 200 MPH
