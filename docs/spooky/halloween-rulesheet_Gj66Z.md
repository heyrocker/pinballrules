---
title: "Halloween Rulesheet"
discourse_topic_id: 7933
manufacturer: "Spooky Pinball"
opdb_id: "Gj66Z"
source: https://tiltforums.com/t/halloween-rulesheet/7933
---
...
- [Jack-O-Lantern Modes](#heading--jack)
- [Multiball Modes](#heading--multiball)
  - [Hedge Multiball](#heading--hedgemb)
  - [Sanitarium Multiball](#heading--sanitariummb)
  - [House Multiball](#heading--housemb)
- [Other Features](#heading--other)
  - [Blood & Store](#heading--blood)
  - [Combos](#heading--combos)
  - [Extra Balls](#heading--extraball)
  - [End-of-Ball Bonus](#heading--bonus)
- [Boogeyman (Mini-Wizard Mode)](#heading--boogeyman)
- [The Night He Came Home (Wizard Mode)](#heading--night)

## Game Information & Overview: {#heading--gameinfo}
- Design: Koris Barloff
- Programming: Fawzma (Updates by Matt Kemp)
- Code/Rules: Fawzma, Bug (Updates by Luke Peters)
- Lead Mechanical Engineer: Koris Barloff
...
- Plunging the ball and immediately shooting the Judith Tombstone scores a secret skill shot and immediately locks the ball behind the drop target there. This locked ball can be released to start Tombstone Multiball or it serves as a de-facto "ball save" that activates if the player drains.

## Jack-O-Lantern Modes: {#heading--jack}
Complete the center drop targets, then shoot the Jack-O-Lantern scoop to select and start a main mode using the flippers. Each drop target completion also lights **[blood](#heading--blood)** at three shots for about 20 seconds. For each mode that has been successfully won on the same ball, an orbit shot will be required to raise the drop targets to qualify the next mode. The number of orbit shots increases by 1 for each mode won on the same ball. Winning two modes in a game lights the **[extra ball](#heading--extraball)**.

Jack-O-Lantern modes *can* be started during any **[multiball mode](#heading--multiball)**, but the player will not get a choice of mode like they normally would; instead, the easiest mode that hasn't been completed will start.
...
### House Multiball: {#heading--housemb}
House Multiball is progressed towards on the upper playfield, and has two distinct phases: "**House Attack**" (the process of qualifying it), and then the multiball itself. To light House Attack, the player must first make five shots to the center ramp. House Attack can also be qualified by completing **[Hedge Multiball](#heading--hedgemb)** and **[Sanitarium Multiball](#heading--sanitariummb)**, and can be started instantly by making a shot to the ramp that passes through the left and right drop targets.
...
- Winning two **[Jack-O-Lantern modes](#heading--jack)**
- Spending 12 **[blood](#heading--blood)** on one (instantly awarded)

### End-of-Ball Bonus: {#heading--bonus}
## Boogeyman (Wizard Mode): {#heading--boogeyman}
...
- Phase 1 (3-Locks): Hedge 1, Hedge 2, Hedge 3
- Phase 2: (2-Locks): Jack-O-Lanterns Scoop, Sanitarium Scoop
- Phase 3 (1-Lock): Crossing Shot
- Multiball: If the player drains during this mode the previous locked ball will be released and must be relocked before continuing. Lock all six balls to watch Loomis fire six shots, knocking Michael Myers off the house balcony. This will start a six ball multiball with all major shots lit yellow and blue for jackpots.
...
* **Phase 1:** At the start of each new location, a shot will be flashing white as a hurry-up to lock in the jackpot value for the remainder of that location. Collecting these quickly is key for huge scoring opportunities. If not collected, the hurry-up will end with a minimum jackpot value of a million points.

* **Phase 2:** All knife inserts, plus the drop targets on the middle and upper playfield are lit white (blade) / orange (handle) shoot any of these for a jackpot. Collecting a jackpot will turn the blade of the knife red, for a short time. Shooting it while red will score a double jackpot. Knife inserts will unlight after they have been collected, but can be relit by completing the crossing shot on the upper playfield. Each jackpot or double jackpot collected will advance the progress tracker to reach the next location. When a new location is reached there will be a fresh ball save timer and add-a-ball.
...
* Halloween Mask: Travel further per each shot (30 seconds)

* Rope: Slow the fuel timer. (30 seconds)

* Knife: Jackpot value increased. (30 seconds)
