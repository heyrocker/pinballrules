...
- [Family Members](#heading--familymembers)
  - [Herman](#heading--herman)
  - [Spot](#heading--spot)
  - [Lily](#heading--lily)
  - [Grandpa](#heading--grandpa)
  - [Raven](#heading--raven)
- [Other Major Features](#heading--majorfeatures)
  - [Kitty (Playfield Multipliers)](#heading--kitty)
  - [Super Jackpots](#heading--superjackpots)
- [Other Features](#heading--otherfeatures)
  - [Chattering Teeth](#heading--teeth)
  - [Eddie](#heading--eddie)
  - [Marilyn](#heading--marilyn)
  - [Zap Meter](#heading--zapmeter)
  - [Dragula](#heading--dragula)
  - [Add-A-Ball](#heading--addaball)
  - [Mystery Award](#heading--mysteryaward)
  - [Combos](#heading--combos)
  - [Secret Mania](#heading--secret)
  - [Extra Balls and Special](#heading--extraball)
  - [Bonus](#heading--bonus)
...
Playing all five modes once will qualify the scoop to start **[Munster Madness](#heading--munstermadness)**.
...
Shoot the left or right ramp when they are lit with a red light to collect a SPOT letter and briefly raise Spot from under the left ramp. If Spot is hit during this brief period, you'll collect a bonus letter in SPOT. Completing SPOT will begin Spot's mode, and simply starting the mode will count as completing a level. Spot's mode is divided into two parts:
  - Stage 1: Spot raises up from under the left ramp. Shoot Spot four times for increasing awards, but beware the risky feed. Completing all four shots will qualify the Spot **[Super Jackpot](#heading--superjackpots)**. Base shot value is 150k, increasing by 100k per shot.
...
Completing any **[Family Member](#heading--familymembers)** level will enable the Kitty Target to advance a playfield multiplier. The multiplier advances from 2x to 3x to 6x and lasts for about a minute. Hitting the Kitty Target while the playfield multiplier is active will reset the timer, and awards points and bonus multipliers.
...
- [**Herman**](#heading--herman) - Collect four Jackpots during Herman Multiball.
- [**Spot**](#heading--spot) - Spell SPOT by completing four shots during Spot's mode.
- [**Lily**](#heading--lily) - Collect 100 switch hits during Lily's mode.
- [**Enlarging Ray**](#heading--grandpa) - Collect four Jackpots during Enlarging Ray.
- [**Raven**](#heading--raven) - Collect four Jackpots during Raven Multiball.
- [**Eddie**](#heading--eddie) - Collect five Eddie Loops.
- [**Marilyn**](#heading--marilyn) - Collect two boyfriend departures.
- [**Zap**](#heading--zapmeter) - Collect four Zap Jackpots.
- [**Mystery Award**](#heading--mysteryaward) - Immediately made available upon collecting a Mystery Award.
- [**Chattering Teeth**](#heading--teeth) - Lit after collecting 24 and 160 chattering teeth.
- [**Grandpa (Prem/LE)**](#heading--grandpa) - Collect the Machine Jackpot during Grandpa Multiball.
...
- 24 - Light chattering teeth **[Super Jackpot](#heading--superjackpots)**
- 36 - +1x bonus
- 48 - Light **enlarging ray**
- 60 - +1x bonus
- 75 - **[+1x playfield](#heading--kitty)**
- 90 - Light **[mystery](#heading--mysteryaward)**
- 110 - Light **[extra ball](#heading--extraball)**
- 130 - Light **[secret mania](#heading--secret)**
...
After playing **[Munster Madness](#heading--munstermadness)**, accumulated chattering teeth will reset to 0.

### Eddie

Shooting an unlit orbit or rolling over the flashing right inlane or outer left inlane will qualify the opposite orbit to score an Eddie Loop. Make successive Eddie Loops to score an increasing value, starting at 20k and increasing by 20k per loop. Every 5 Eddie Loops will qualify the Eddie **[Super Jackpot](#heading--superjackpots)** if it isn't already available.
...
The Marilyn **[Super Jackpot](#heading--superjackpots)** will also light at every 2 departures scored.

Zap Meter

Hitting any standup target will make the Zap Button flash for a short time. Pressing the button will charge up the Zap Meter; the Zap Meter goes to 5. Zap Jackpots appear on shots where you have just made another type of jackpot, which decrements the Zap Meter. Collecting enough Zap Jackpots will qualify the Zap **[Super Jackpot](#heading--superjackpots)**.
...
**Available Mystery Awards:**
  ...
  - **[Start Member](#heading--familymembers)** (any of the five, even Raven if the advances at the left ramp are qualified)
  - Boost Member (same as the boost awarded off of **[Dragula](#heading--dragula)**)
...
Bonus is a predetermined value (based on switch hits) plus 10k * **[levels](#heading--familymembers)** completed, times the bonus multiplier (which goes up to 20x).
