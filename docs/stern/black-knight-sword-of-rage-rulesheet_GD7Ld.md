...
- [Multiball Modes](#heading--multiballs)
  ...
  - [Catapult Multiball (Prem / LE Exclusive)](#heading--catapultmb)
  - [KNIGHT Multiballs](#heading--knight)
- [Other Scoring](#heading--other)
  - [Super Modes & Super Jackpot](#heading--supers)
  - [U-Turns](#heading--uturns)
  - [WAR Hurry-Up](#heading--war)
  - [Mystery](#heading--mystery)
  - [Ball Save](#heading--ballsave)
  - [Magna-Save](#heading--magnasave)
  - [Last Chance (Prem / LE Exclusive)](#heading--lastchance)
  - [Extra Balls](#heading--extraballs)
  - [End-of-Ball Bonus](#heading--bonus)
- [Black Castle (Wizard Mode)](#heading--blackcastle)
...
## Multiball Modes: {#heading--multiballs}
Note: Premium/LE machines can progress towards and activate **[Triple Knights](#heading--tripleknights)** and **[Catapult](#heading--catapultmb)** multiballs during one another.
...
Upon scoring the hurry-up, all shots light for jackpots based on the value of the hurry-up. Complete all of the shots to light the Ramp for a Super Jackpot, worth 3x the value of the jackpot and a **[KNIGHT letter](#heading--knight)**. Similarly to the end of the first phase, a strong shot must be made to the ramp that goes all the way around. Triple Knights Challenge returns to the first phase, albeit with boosted scoring, after the super jackpot has been collected.
...
## Other Scoring: {#heading--other}
### Super Modes & Super Jackpot: {#heading--supers}
A random, untimed Super Mode (Lanes, Slings, Spinner, Orbits, Targets, Pops) can be started at the center target when "SUPER" is lit, via enough right spinner spins. Super Modes remain active until the ball drains, and you can shoot the left lane to boost the values of all active Super Modes when any of them are running (unless **[KNIGHT Multiball](#heading--knight)** is running, in which case their values are locked in). The boost for a Super Mode is maxed when their icon (and accompanying playfield insert) turn purple.

The values from all active Super Modes can be cashed out as a "Super Jackpot" by successfully using the **[Magna-Save](#heading--magnasave)** to save a ball. This will also end all active Super Modes, and can be multiplied by the playfield multipliers during **[KNIGHT Multiball](#heading--knight)**.
...
### WAR Hurry-Up: {#heading--war}
Complete the top lanes to increase the **[bonus multiplier](#heading--bonus)** and light all three of the center shots for a hurry up; each shot has a base value starting at 3M, increasing with pop bumper hits, and maxing out at 25M. The flail has to be hit in order to shoot the ramp, and on subsequent attempts, the shield must be hit once to collect its hurry up (although **[Mystery](#heading--mystery)** takes priority if lit). Collecting all three awards will light the center target to complete the round and score a **[KNIGHT letter](#heading--knight)**. More lane completions will be required to begin the hurry-up on subsequent attempts.
...
* **[Add KNIGHT Letter](#heading--knight)**
* **[Light Super](#heading--supers)**
* **[Advance Save](#heading--ballsave)** (by 1 target set)
* **[Light Magna-Save](#heading--magnasave)**
...
## Black Castle (Wizard Mode): {#heading--blackcastle}
Once all five **[battles](#heading--battles)** have been won, the sixth battle, Black Castle, will be qualified and can be started in the same way as the other battles. Unlike the other battles, however, Black Castle is mutually exclusive and is a 200-second timed mode.
