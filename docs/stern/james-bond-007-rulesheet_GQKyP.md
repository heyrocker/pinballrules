...
Skill shot opportunities are given at the start of each ball, but also following any mode that ends with the flipper power cutting off and the ball returning to the plunger. These modes are: the four **[Q Branch](#heading--gadgets)** multiballs, **[Bond... James Bond](#heading--miniwizard1)** multiball, and the **[villain mini-wizard modes](#heading--miniwizard2)**. On Prem / LE models, skill shot opportunities are also given after each ball lock for **[Bird 1 multiball](#heading--birdone)** if physical locks are enabled.
...
- **Trouble in Jamaica** (*Dr. No* | Yellow): Negotiate with "Dr. No" and learn about SPECTRE's plans with shots to the bumpers via either the bumper lane or the right orbit to build up an award, which can be cashed out by shooting the Dragon Tank. The mission ends after making 10 successful shots.
  - 75 seconds.
...
- **SPECTRE Island** (*Rosa Klebb* | Red): Navigate Rosa Klebb's training facilities. All nine major shots are lit to score. After completing all nine shots, the left eject and the DB5 eject must be made in order to win the mission.
  - 70 seconds.

- **The Incredible Laser Ray** (*Goldfinger* | Amber): Goldfinger has captured Bond and informed him of his evil plans! Three shots are lit at a time, and the Goldfinger target between the side ramp and right orbit is flashing. Shoot the Goldfinger target to light a different set of shots, and score a value incremented by 250k by shooting the lit shots. Make 7 total shots to light the DB5 eject to win the mission and escape from Goldfinger's clutches alive.
  - 60 seconds.

- **Disco Volante Demolition** (*Largo* | Orange): Make shots to the left eject, side ramp, or right ramp to infiltrate the Disco Volante. After making either ramp shot, the left eject will be the only shot lit. Make 10 shots to win the mission.
  - 70 seconds.
...
- **Feeding Frenzy** (*Blofeld* | Green): Blofeld has taken note of Bond's presence and has harsh punishments planned for his henchmen who fail to make the cut. Make 9 shots to the Bird 1 rocket or the drop targets in front of it to win the mission.
  - 40 seconds.
  - Direct shots to the rocket score 2x.
  - Progress cannot be made towards lighting locks for or starting **[Bird One Multiball](#heading--birdone)** during this mode.

- **Diamonds of Destruction** (*Mr. Henderson* | Blue): Calibrate the satellite and destroy the missile testing facility with shots to the left eject, center loop, and right ramp are lit. One of those three shots will be flashing - it can be moved from left to right by shooting the spinner. Make 9 shots to win the mission.
  - 70 seconds.
...
- **Encounter on the Orient Express** (*Red Grant* | Red): Battle Red Grant and navigate through the train by shooting the right orbit, which will temporarily light all of the shots on the right side of the playfield for combo shots. Make 10 red shots to win.
  - 70 seconds.
...
- **He Blew a Fuse** (*Oddjob* | Amber): Four shots are lit - the left ramp, the side ramp, the right orbit, and the right ramp. Once all four shots are made, shoot the rocket lane to win the mode and defeat Oddjob for 9M.
  - 60 seconds.

- **Femme Fatale** (*Fiona Volpe* | Orange): Chase down Fiona by making the following seven shot sequence - left ramp, right ramp, left ramp, right orbit, side ramp, left ramp, DB5 eject. Make all seven shots to win.
  - 70 seconds.
...
Play all six countdowns for a **[wizard mode](#heading--miniwizard2)**.

- **Troublesome Tarantulas** (*Dr. No* | Yellow): The right ramp and side ramp are lit for a 10M hurry-up that counts down over 15 seconds. Shooting any lit shot ends the mode. Side ramp scores 2x the value. Once completed, all mode timers are extended by 17 seconds, and **[007 Scoring](#heading--pfx)** is extended by 7 seconds.
- **Deadly Dagger** (*From Russia With Love* | Red): The right orbit and side ramp are lit for a 10M hurry-up that counts down over 15 seconds. Shooting any lit shot ends the mode. Side ramp scores 2x the value. Once completed, all ball save timers are extended by 7 seconds.
- **Death By Derby** (*Goldfinger* | Amber): The side ramp and DB5 eject are lit for a 10M hurry-up that counts down over 15 seconds. Shooting any lit shot ends the mode. Side ramp scores 2x the value. Once completed, the **[High Stakes mystery award](#heading--mystery)** is upgraded and will award 5 awards that cannot normally be obtained.
- **Swimming With Sharks** (*Thunderball* | Orange): Left ramp, rocket lane, right orbit, and right ramp are lit for a 10M hurry-up. Once a hurry-up is collected at any shot, the next hurry-up is worth 10M more than the previous one. Mode ends after collecting all four hurry-ups. Once completed, *two* **[smart missiles](#heading--missiles)** are awarded instead of one, and each subsequent ball will start with +2 smart missiles.
...
- **Power Pack** (*Thunderball* | Orange):
  - Qualified after three shots to the **[left eject](#heading--random)**. Progress is carried across balls.
  - 70 seconds.
...
- Light **[Q Branch](#heading--gadgets)** (for the mode corresponding to the element)
- Power Points (10M; 5M for left eject, 20M for spinner)

Every hit that counts down towards an award also counts down towards lighting the upper loop for a **[Bond Woman](#heading--pfx)**. Progression towards Bond Women is kept separately from that of the other awards.
...
- Start **[Henchmen Mode](#heading--henchmen)**
- Advance **[SPECTRE Letter](#heading--spectre)** (+2 SPECTRE letters)
- Light **SPECTRE Weapon** (at the Goldfinger target)
- Light **[Bird One Multiball](#heading--birdone)** Lock
- Advance **[Jetpack](#heading--jetpack)**
- Advance Spinner
- Advance Bumpers
- Advance Rocket
...
Completing the **[SPECTRE Weapon countdown](#heading--spectre)** *"Death by Derby"* upgrades the mystery awards and adds five awards to the rotation that can't otherwise be scored:

- **[Bond Women Multiplier](#heading--pfx)** Awarded (the next highest up the ladder, from left to right)
- Hold Bond Women Multipliers (to the next ball, only)
- **[+1 Smart Missile](#heading--missiles)**
...
- 25 bumper hits (*Honey Ryder*)
- 3 right orbit shots (*Tatiana Romanova*)
- 4 DB5 ejects (*Pussy Galore*)
- 4 left ejects (*Domino Derval*)
- 10 rocket hits (strong shots register more) (*Kissy Suzuki*)
- 200 spinner spins (*Tiffany Case*)
...
- Making any of the **["super skill shots"](#heading--skillshots)** (ie. holding the left flipper, then shooting any flashing lane - only one per unique super skill shot)
- Completing any mode (**[villain](#heading--villain)**, **[henchmen](#heading--henchmen)**, **[weapon](#heading--spectre)**, or **[Q Branch](#heading--gadgets)**)
- **[Upgraded mystery award](#heading--mystery)**, if the player has completed **[Death by Derby](#heading--spectre)** weapon mode
- Scoring the **[martini shot](#heading--combos)**
- 2 are given at the start of every ball, if the player has completed **[Swimming With Sharks](#heading--spectre)** weapon mode
...
- At thresholds of 3, 6, 12, and 18 of *any* modes played: **[villain](#heading--villain)**, **[henchmen](#heading--henchmen)**, **[weapon](#heading--spectre)**, or **[Q Branch](#heading--gadgets)**
...
- Starting a **[SPECTRE weapon countdown](#heading--spectre)**: 500k
...
- Start a **[henchmen mode](#heading--henchmen)**.
- Start **[Bird One Multiball](#heading--birdone)**.
- Start **[Jetpack Multiball](#heading--jetpack)**.
...
- Start all 6 **[Q Branch modes](#heading--gadgets)**.
- Start all 6 **[SPECTRE Weapon countdowns](#heading--spectre)**
...
**[007 scoring](#heading--pfx)** and **[smart missiles](#heading--missiles)** are disabled during On Her Majesty's Secret Service.
...
After MI6 Multiball ends, **[end-of-ball bonus](#heading--bonus)** is awarded one last time, and the game ends.
[/details]