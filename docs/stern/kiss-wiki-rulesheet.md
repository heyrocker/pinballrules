...
- Original Wiki Rulesheet hosted on [Tilt Forums](/stern/kiss-wiki-rulesheet)
...
In version 1.40.0, song completion allows for further scoring opportunities. Completing a song awards an untimed 2x, 3x, 5x, or 10x Playfield Multiplier for the remainder of that ball, increasing with the number of songs completed during that ball.
...
Phases:
1) Collect each of the 4 Instrument shots
2) Spell KISS ARMY via the standup banks
3) KISS Towers: Hit 25 pops.
4) Spell DEMON by shooting the Demon head 5 times.
5) Get 16 hits on Starchild targets.
6) Get 25 spins.
7) ??