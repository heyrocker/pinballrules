...
[Official Rulesheet for 0.96 code](https://stern-wagtail-1.s3.amazonaws.com/media/documents/Star-Wars-Fall-of-the-Empire-Rulesheet-v8-compressed.pdf)
...
- [Other Scoring](#heading--other)
  ...
  - [Dark Side Mystery](#heading--darkside)
...
- Original Wiki Rulesheet hosted on [Tilt Forums](/stern/star-wars-fall-of-the-empire-rulesheet)
...
- Either bumper - scores 3 hits towards the next **[shot multiplier](#heading--shotx)**.
- Left orbit - adds 2 **[JEDI letters](#heading--jedi)**.
- Luke VUK - spots 3 **[FORCE letters](#heading--modes)**.
- Droids target - spots 1 lock towards **[battle of hoth multiball](#heading--hoth)**. Won't start it.
- Death Star - spots 1 lock towards **[death star multiball](#heading--deathstar)**. Won't start it.
- Center ramp - spots 2 shots worth of progress towards the next **[falcon feature](#heading--falcon)**.
- Sarlacc Pit / drop target - spots 2 shots worth of progress towards the next **[Jabba event](#heading--jabba)**.
- Right ramp - adds 3 **[TIE fighters](#heading--tiefighter)**.
...
- **Chewie**: Sarlacc Pit spins build the shot values by 50k per spin. Han center ramp scores 2x its normal mode value. Missions: **Dejarik** (green), **Find C-3PO** (yellow), **Fix C-3PO** (orange)
  - **Reunion**: Shoot the center ramp to increase the per spin value of the Sarlacc Pit, with each Pit shot resetting the timer. The first shot is the Pit, second is the center ramp, third is the Pit, fourth is the Luke VUK, and fifth is the Pit again. The final shot of the mode is at the center ramp and can be boosted via Pit spins before scoring it.
- **Leia**: Prioritizes the Luke VUK and Han center ramp as build shots. Right ramp scores 2x its normal mode value. Missions: **Jailbreak** (green), **Trash Compactor** (yellow), **Rescuing Han** (orange)
  - **Speeder Bikes**: Shoot the Luke VUK to light the orbits and ramps for hurry-up awards starting at 12.5M. Making 8 shots will lock in the hurry-up award value and start a 2-ball multiball where each lit shot scores the hurry-up value. Once all 8 major shots are made during the multiball, the right ramp will score their combined value as a super jackpot and complete the mode.
- **Obi-Wan**: Any time the Luke VUK or Obi-Wan right orbit are lit blue, they will score 2x their normal mode value. Missions: **Ben Meets Luke** (green), **The Message** (yellow), **Duel with Darth Vader** (orange)
  - **Revealing the Truth**: VERY long mode with ball save checkpoints at each shot threshold described below. Advance through the scene by hitting any of the Vader scoop, Luke VUK, right ramp, or right orbit. If the shot hasn't been made yet, the score from that shot will be doubled; and at 7, 14, 21, and 28 shots, only Vader scoop and Luke VUK will be lit to advance. Complete the mode by making 28 total lit shots.

Complete two, then six missions to light **[extra ball](#heading--extraballs)**.
...
- **Lightspeed Escape / Lightspeed Multiball**: The center ramp will start Lightspeed Escape, lighting the center ramp (timed) to immediately begin Lightspeed Multiball and lighting other shots to substantially increase the jackpot *before* starting the multiball. If you drain or run out of time during Lightspeed Escape, then similar to Alderaan's fate, your opportunity for Lightspeed Multiball is gone. During the 2-ball multiball, hit 3 lit shots (+1) to score jackpots and eventually light a looping super jackpot that can be scored with repeated shots to the center jump ramp on a time limit. After the super jackpot timer expires, the jackpot phase repeats. The jackpot starts at 500k + 250k for each Lightspeed Escape build shot + 50k for each multiball jackpot, and the super jackpot is worth 5x the current jackpot value.
...
- **Jabba's Palace**: Drop target mode. Shoot the flashing shots to light the Salacious Crumb drop target for more and more points. Every time the drop target award is scored, the timer is reset and more shots must be made to relight the drop target. Scoring three drop target hits will light the Sarlacc Pit to score 5x the current award value and complete the mode, or the player can keep on hitting shots to light the drop target.
- **Rancor Battle**: This is an *untimed* mode where the player must complete a sequence of lit shots to fend off the Rancor: Luke VUK, right orbit, right ramp, center ramp x2, Luke VUK, and finally the Sarlacc pit. The mode only ends if the player drains or completes all the shots that were required. Combo-ing shots within about 10 seconds of each other increases the multiplier for the next award to a max of 3x.
...
**Rebel Assistance (faster jackpot progress)**: Level up your characters each ball through **[Rebel Combos](#heading--combos)** to help progress through multiballs easier. A pulsing character *Name* insert (for one combo made) collects 2 jackpots in one shot, and a solidly lit character Name insert (for two combos made) collects 3 jackpots. Note: Rebel Assistance does not apply to non-multiball mode shots, even if stacked with a multiball.
...
- 15M points
- Light **[rebel missions](#heading--missions)**
- Advance **[Falcon](#heading--falcon)**
- Advance **[Hoth](#heading--hoth)**
- Advance **[Death Star](#heading--deathstar)**
- Add charges to **[ion cannons](#heading--shotx)**
- Advance **[JEDI](#heading--jedi)** (award 2 letters)
- **[Stormtrooper hurry-up](#heading--stormtrooper)**
- Light **[extra ball](#heading--extraballs)** (percentage-based, once per game)
- Mynock Multiball (Prem / LE exclusive): Similar to AFM's Strobe Multiball, shoot the lowered Center Ramp/Dead-end 10 times to light an **[extra ball](#heading--extraballs)**. 10M per lowered ramp shot, and 25M for the 10th ramp shot if extra ball has already been lit during this mode. This is made available after scoring two mystery awards, and only if a multiball isn't running.
...
- Completing the first **[Jabba Event](#heading--jabba)** of a game
- Making 5 lit shots during **[Dark Side Scoring](#heading--vader)**
- Scoring 10, 30, and 60 **[TIE fighters](#heading--tiefighter)** from the right ramp
- Lighting it from a percentage-based **[mystery award](#heading--mystery)**
- Hitting the lowered center ramp 10 times during **[mynock multiball](#heading--mystery)** (Prem / LE exclusive)
...
- 300k per **[Jabba Event](#heading--jabba)** started
- 1M per Jabba Event completed
- 300k per **[Falcon Feature](#heading--falcon)** started
- 1M per Falcon Feature completed
- 300k per **[Vader Mode](#heading--vader)** started
- 1M per Vader Mode completed
- 150k per **[Rebel Combo](#heading--combos)** collected
- 1.5M per Super Jackpot collected (in either **[Battle of Hoth](#heading--hoth)** or **[Death Star](#heading--deathstar)** multiballs)
- Total points from completed **[super modes](#heading--combos)**
