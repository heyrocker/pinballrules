---
title: "Stern The Beatles Rulesheet"
discourse_topic_id: 7840
manufacturer: "Stern Pinball"
opdb_id: "G0l8P"
source: https://tiltforums.com/t/stern-the-beatles-rulesheet/7840
---
...
- [Wizard Modes](#heading--wizardmodes)
  - [Hard Day's Night / Beatlemania! Multiball](#heading--harddaysnight)
  - [Taxman Multiball](#heading--taxman)
- [Other Features](#heading--otherfeatures)
  - [Drop Target Banks](#heading--droptargetbanks)
...
Taxman Multiball:
After reaching level 5 in all 5 modes, a shot to the upper magnet will begin Taxman Multiball. This is a 4-ball Multiball where all four of the single-ball modes described above are active and completing the 4 Beatles standup targets will add a ball. Completing the F-A-B and F-O-U-R drop targets lights jackpot at the top magnet, and completing all three drop target banks (FAB, FOUR, and 1964) lights the super jackpot behind the F-A-B drop targets. Modes then reset when the player drains down to a single ball.
...
* **Advance Loops**: Completing a drop target bank will light its "Advance Loops" insert solid and increase the **[loop value](#heading--loopvalue)** by that number. The solidly lit blue inserts indicate the loop value.
...
- 25k
- Advance **[Bonus X](#heading--droptargetbanks)**
- 2x pop bumpers
- 50k
- 2x left spinner
- **[BEATLEMANIA Letter](#heading--beatlemaniaawards)**
- 2x right spinner
