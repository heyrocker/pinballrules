---
title: "The Walking Dead Remastered Rulesheet"
...
- [Multiballs](#heading--multiball)
  - [Prison Multiball](#heading--prison)
  - [Well Walker Multiball](#heading--well)
  - [Blood Bath](#heading--bloodbath)
- [Other Scoring](#heading--other)
  - [Multi-Kills](#heading--multikill)
  - [Drop Targets / Supplies](#heading--supplies)
  - [Bicycle Girl Hurry-Up](#heading--bicyclegirl)
  - [2X Playfield](#heading--2x)
  - [Pop Bumper Jackpot](#heading--pops)
  - [Fish Tanks / Woodbury](#heading--woodbury)
  - [Crossbow](#heading--crossbow)
  - [Flamethrower Jackpot](#heading--flamethrower)
  - [Combos](#heading--combos)
  - [Bit](#heading--bit)
  - [Escape! (Outlane Ball Save)](#heading--escape)
  - [Extra Balls](#heading--extraballs)
  - [End-of-Ball Bonus](#heading--bonus)
- [Mini-Wizard/Wizard Modes](#heading--wizardmodes)
  - [Horde](#heading--horde)
  - [Siege](#heading--siege)
  - [Crossbow Frenzy](#heading--frenzy)
  - [Escape Terminus](#heading--terminus)
- [Last Man Standing (Wizard Mode)](#heading--lastmanstanding)
- [Competition Mode Settings](#heading--compsettings)
...
- Original Wiki Rulesheet hosted on [Tilt Forums](/stern/the-walking-dead-remastered-rulesheet_Gj6DE)
...
## Walker Kills & Shot Multiplier: {#heading--walkers}
While *The Walking Dead* has modes and multiballs as expected, the main wizard mode, **[Last Man Standing](#heading--lastmanstanding)**, doesn't require any of them to be played. Instead, the player must accumulate a total of 115 Walker kills to light it.

The white crosshairs at all major shots, including the Well Walker, kill Walkers and increase the total kill count seen above the flippers by 1. There will always be 3 shots lit for Walker kills at a time, and the same shot cannot kill a Walker multiple times in a row. Every Walker killed adds 50k to **[end-of-ball bonus](#heading--bonus)**. If a **[Multi-Kill](#heading--multikill)** is running, each shot lit with a yellow circle will kill 2 Walkers regardless of if the crosshair insert is lit.
...
Killing 5 Walkers (and every 20 Walker kills thereafter) lights the left ramp for **[Bicycle Girl](#heading--bicyclegirl)**. Killing a percentage-based (defaults to 10) amount, then 60 Walkers will light the **[extra ball](#heading--extraball)** at the Woodbury lane.
...
- **CDC**: Started at the left ramp. Each left ramp shot scores 750k + 25k per ramp, and adds a white arrow on the playfield, from left to right. Shooting a white arrow unlights it, scores 2.5M, and qualifies the left ramp for two shots to finish the mode; the first shot is worth the award value, and the second shot is worth the total value of all white arrows made. Make any 3 lit shots for Multi-Kill.
...
Once all 5 Dead Features have been played, the next Dead Feature will be **[Escape Terminus](#heading--terminus)**. Once Escape Terminus has been played, all Dead Features reset and can be started again.

## Multiballs: {#heading--multiball}
Multiballs on *The Walking Dead* are less about scoring opportunities and more about providing utility to help with killing **[Walkers](#heading--walkers)** and lighting / playing **[Dead Features](#heading--deadfeatures)**, but can be worth large amounts of points if the player makes it far enough into the multiball.

**[Blood Bath](#heading--bloodbath)** is the only multiball that can be stacked with another multiball; the order in which the multiballs are started does not matter. You can not advance progress towards **[Prison](#heading--prison)** while **[Well](#heading--well)** is running and vice versa. Timed modes like Dead Features started before multiball continue to run during multiball. If one times out during multiball, additional Dead Features can be started by clearing the drop target bank multiple times (default settings only).
...
Collect three jackpots during Well Walker Multiball to start a **[Multi-Kill](#heading--multikill)**.
...
Collect three jackpots during Blood Bath to start a **[Multi-Kill](#heading--multikill)**.
...
|**Riot** Dead Feature|3 Riot shots|
|**Tunnel** Dead Feature|2 lit shots|
|**Arena** Dead Feature|3 right ramp shots|
|**[Prison Multiball](#heading--prison)**|4 jackpots|
|**[Well Walker Multiball](#heading--well)**|3 jackpots|
|**[Blood Bath](#heading--bloodbath)**|3 jackpots|
|**[Drop Targets](#heading--supplies)**|10 completions|
|**[Bicycle Girl](#heading--bicyclegirl)**|3 hurry-ups|
|**[Crossbow](#heading--crossbow)**|3 successful shots|
|**[Fish Tanks](#heading--woodbury)**|3 tanks completed|
|**[Woodbury](#heading--woodbury)**|Collect Start Multi-Kill|
|**[Combos](#heading--combos)**|10 combo shots|

### Drop Targets / Supplies: {#heading--supplies}
Along with lighting **[Dead Features](#heading--deadfeatures)**, each drop target completion awards the currently flashing supply. The flashing supply moves from bottom to top, and is locked in once any drop target is hit. Collecting a full set of supplies qualifies **[Blood Bath](#heading--bloodbath)** multiball, and each individual supply also awards the following:

- **First Aid**: Increases the value of **[prison yard](#heading--prison)** Walkers by 100k, and lights the action button for Prison Bomb if the prison doors are open. Prison Bombs can be used to advance 1 hit towards or collect a jackpot during Prison Multiball.
- **Weapons**: Lights the right ramp for **[Crossbow](#heading--crossbow)** and qualifies a Horde Bomb. Horde Bombs can be used to spot a Walker kill during **[Horde](#heading--horde)** mini-wizard mode.
- **Food**: Increases the shot multiplier for the **[Well Walker](#heading--well)** which resets once used, and lights the action button for Well Walker Bomb if Well Walker mode is active. Well Walker Bombs can be used to advance 1 hit towards or collect a jackpot during Well Walker Multiball.

Every 10 completions of the drop targets, at any time during play, starts a **[Multi-Kill](#heading--multikill)**.
...
Shooting the lit Tower 10 times through this method lights **[extra ball](#heading--extraballs)**.
...
The awards are added in the following order:

- Light **[bit](#heading--bit)**
- Double **bit** value
- Light **[outlane ball save](#heading--escape)**
- Light **[X](#heading--walkers)** inlane
- Light **[crossbow](#heading--crossbow)**
- **[Collect bonus](#heading--bonus)**
- Start **[multi-kill](#heading--multikill)**
- Light **[extra ball](#heading--extraballs)**

### Crossbow: {#heading--crossbow}
Crossbow is lit at the right ramp after the **[weapons supply insert](#heading--supplies)** is collected during single-ball play. The next time the right ramp is shot, the ball will be cradled in a cannon located below the flippers, and the player will be prompted to press the action button to fire the crossbow for an award between 1.5M to 2.5M points. Multiple crossbow "attempts" can be stacked at once if you have collected the weapons supply insert multiple times.

Once three crossbow shots have been successfully made, **[Multi-Kill](#heading--multikill)** will start and **[Crossbow Frenzy](#heading--frenzy)** will activate.

### Flamethrower Jackpot: {#heading--flamethrower}
Hit the Woodbury drop target twice (+1 per activation) to light **[Woodbury](#heading--woodbury)** and light the spinners at both the left orbit and Woodbury lane. While lit, every spinner spin adds 15k to the Flamethrower jackpot that can be scored by making a shot to the Woodbury lane that makes it all the way to the plunger.
...
Combos score 500k + 37.5k per combo.

Every 10 combos scored during a game will start a **[Multi-Kill](#heading--multikill)**.
...
**[Woodbury](#heading--woodbury)** can light both outlanes for Bit or double the current Bit value.

### Escape! (Outlane Ball Save) {#heading--escape}
Light Escape at both outlanes by:

- Collecting **[first aid](#heading--supplies)** from the drop targets
- Hitting the lit **[tower](#heading--2x)** target enough times
- Lighting it from **[Woodbury](#heading--woodbury)**

When Escape is available, the "Bit" insert at both outlanes will be flashing slowly. The next ball that drains down an outlane lit for Escape will be saved, and Escape then must be lit again.

### Extra Balls: {#heading--extraballs}
Light extra ball at the Woodbury lane by:

- Killing a percentage-based amount (usually around 10), then 60 **[Walkers](#heading--walkers)**
- Scoring 10 lit **[tower](#heading--2x)** shots
- As an award from **[Woodbury](#heading--woodbury)**

When extra ball is lit, the drop target will always lower to allow it to be collected.

### End-of-Ball Bonus: {#heading--bonus}
Bonus is calculated using a base bonus and a Walker bonus. The base bonus resets across balls, and is calculated as:

- 370 x switch hits (anything hit on playfield)
- 25k x **[combos](#heading--combos)**
- 250k x **[dead features](#heading--deadfeatures)** started
- 75k x spellouts (either **[PRISON](#heading--prison)** or **[WELL](#heading--well)**)
- 15k x **[supplies](#heading--supplies)**

The Walker bonus carries across the entire game and is calculated as 50k x **[Walkers](#heading--walkers)** defeated. Both base and Walker bonus are multiplied by the bonus multiplier, which increases by +1x to a maximum of 250x with every top lane completion. **Bonus Hold** can be awarded from **[Woodbury](#heading--woodbury)** and carries over the previous bonus to the next ball.

If the player has reached **[Last Man Standing](#heading--lastmanstanding)**, the 115 Walkers that were killed to get there will be consolidated into a burning pile & award 5.75M base bonus.

## Mini-Wizard Modes: {#heading--wizardmodes}
### Horde: {#heading--horde}
Don't get bit!
...
### Siege: {#heading--siege}
Spell PRISON by scoring 12 jackpots in two different **[Prison Multiballs](#heading--prison)** to light this untimed mini-wizard mode that starts with an additional Prison shot.
...
### Crossbow Frenzy: {#heading--frenzy}
Crossbow Frenzy mini-wizard mode starts once the player has made three successful shots using the **[Crossbow](#heading--crossbow)**. As soon as the third shot is registered, the mode will start with a 30-second ball save timer that can be used to save one ball.

The goal of Crossbow Frenzy is to clear out all the lit yellow shots before the Walkers approach and drain your health. The yellow shots include all five major shots, the Prison, and the Well Walker. Shooting the right ramp during this mode always loads the Crossbow, and successfully making a lit shot from the Crossbow will increase the respawn time of the next Walker giving the player more time to hit a lit shot without the risk of their health draining.

The scoring per shot in this mode is based on the combined values of the three prior Crossbow shots. Making the final lit shot scores an additional bonus worth a maximum of 200M that decreases as the player's health lowers, and completes the mode. Making shots using the crossbow during the frenzy increases this bonus further.
...
## Competition Mode Settings: {#heading--compsettings}
Various features in the game are changed if competition mode is active:

- **[Dead Features](#heading--deadfeatures)**: Modes *cannot* be lit during any multiball, but can be brought into them. Only one drop target bank completion is needed to light dead features.
- **[Multi-Kills](#heading--multikills)**: Only the following multi-kills are available:

|Multi-Kill|Requirement|
|---|---|
|**Barn** Dead Feature|5 left orbit shots|
|**CDC** Dead Feature|Complete the mode|
|**Riot** Dead Feature|3 Riot shots|
|**Tunnel** Dead Feature|Complete the mode|
|**Arena** Dead Feature|Complete the mode|
|**[Prison Multiball](#heading--prison)**|Super jackpot|
|**[Well Walker Multiball](#heading--well)**|Super jackpot|
|**[Blood Bath](#heading--bloodbath)**|Super jackpot|
|**[Bicycle Girl](#heading--bicyclegirl)**|Complete the mode (4 hurry-ups)|
|**[Woodbury](#heading--woodbury)**|Collect Start Multi-Kill|

- **[Horde](#heading--horde)**: If a Walker reaches the player, the ball will automatically end. Walkers will pause if the ball is being held at Woodbury for Fight / Escape.