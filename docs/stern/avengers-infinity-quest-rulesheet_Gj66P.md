...
- [Avengers Assemble](#heading--assemble)
  - [Mini-Wizard Modes](#heading--assemblemodes)
    - [Soul Gem Quest](#heading--soulgemquest)
    - [Black Order Multiball](#heading--bomb)
    - [Black Order Battle Royale](#heading--battleroyale)
- [Thanos Modes](#heading--thanos)
  - [Thanos Attacks](#heading--thanosattacks)
...
- [Other Scoring](#heading--otherfeatures)
  - [Computer Grid Awards](#heading--computergrid)
     - [Super Modes](#heading--supermodes)
     - [Computer Frenzy Multiball](#heading--computerfrenzy)
  ...
  - [Gem Mania (Topper Mode)](#heading--gemmania)
...
* Shooting the Time Gem shot will add time to the Master Timer for **[Super Modes](#heading--supermodes)**, or Time Bank (if no timed mode is currently running), based on the times below.
...
The objective of the mode is to shoot 8 lit green shots without running out of flips; shooting a green shot will add flips and draining the ball will subtract flips. **[Mystery](#heading--mystery)** and **Flank Attack** will both spot the currently lit shot (up to once each), but not the final shot at the Tower. **[Mind Gem](#heading--gemplacing)** is also available, but will not spot the final shot at the Tower either.
...
This sequence then repeats - 2 jackpots then captive ball, 3 jackpots then captive ball, etc. until you spell THOR with four runs through the sequence. Super Jackpot will then light at Avengers Tower to score 20x the jackpot value and collect the Thor Multiball *[Trophy](#heading--trophies)*. The process then resets, with additional jackpot shots being required to qualify the captive ball.
...
Qualified by playing all 6 **[Super Modes](#heading--supermodes)**, this multiball will be the next grid award at whatever the most recently completed Super Mode’s position was. After qualifying it, a shot to the right ramp will start the mode.
...
- 50 combos - Light **[Extra Ball](#heading--extraballs)** + *Gold Trophy*
...
* Amateur (Level 1): Timed release, hit either the inner loop or bullseye target for a lit **[Portal Lock](#heading--portallock)** + 3M.
...
- 10 Million
- Begin *[Timed Mode](#heading--supermodes)** (if a super mode is already running, this will always be awarded)
- Advance IRON (1 set)
- Advance THOR (1 set)
- Light **[Hawkeye Challenge](#heading--hawkeyechallenge)**
- Hold Bonus X
- +5x Bonus
- Light **[Change Gems](#heading--gemplacing)**
...
* **[Arc Reactors](#heading--arcreactor)** x 25K
* Upper loop shots x 25K
* **[Combos](#heading--combos)** x 25K

These are saved throughout your whole game:
* *Bronze [Trophies](#heading--trophies)* x 100K
* *Silver Trophies* x 250K
* *Gold Trophies* x 500K
* **[Gems](#heading--gemquests)** Collected x 250K
