---
title: "Guardians of the Galaxy Pinball Rulesheet"
discourse_topic_id: 3338
manufacturer: "Stern Pinball"
opdb_id: "GRWvz"
source: https://tiltforums.com/t/guardians-of-the-galaxy-pinball-rulesheet/3338
---
...
Make it halfway through all modes and start both **[multiballs](#heading--multiballs)** to qualify **[Immolation Initiative](#heading--immolation)**. Complete four modes (excluding multiballs) to qualify **[Cherry Bomb Multiball](#heading--cherrybomb)**, and complete all modes and multiballs to qualify **[Save Xandar](#heading--xandar)**.
...
* **Escape Kyln** (orange)
  ...
  * Complete all of the flashing Nova Corps lanes and Groot, then shoot Rocket (without using **[Hadron Enforcer](#heading--hadron)**) to complete the mode and light a free **[Shot Multiplier](#heading--nova)**. The orbits will divert to the pop bumpers in this mode, allowing you to complete the two top lanes. Rocket remains permanently lit and spots a lit lane when shot.
...
## Multiballs {#heading--multiballs}
During both multiballs, **[Mystery](#heading--mystery)** will always award an add-a-ball the first time it is collected. **[Modes](#heading--modes)** can be brought into both multiballs, and multiballs count towards **[wizard mode](#heading--wizard)** progression just like modes do. Both multiballs are mutually exclusive, and progress towards completing Groot MB is saved across balls.
...
- **Yaka Arrow** - Yondu / dead-end lane
- **Sanctuary** - Ronin / left orbit
- **Escape Kyln** - Rocket kickback
- **Pod Chase** - Nebula / left ramp
- **Antiquities Shop** - Broker / Orb
- **Sibling Rivalry** - Gamora / right ramp
- **Knowhere** - Drax / right orbit
- **Quill's Quest** - Star-Lord / scoop

When all 24 jackpots have been collected, a Double Super Jackpot lights at Groot's mouth, with Groot's mouth repeatedly opening and closing. Collecting the Double Super Jackpot will complete Groot MB and the Jackpots will relight. The Hadron Enforcer cannot be used to collect the Double Super Jackpot.

You can hit Groot again during Groot Multiball to open Groot's mouth. Re-lock a ball in Groot's mouth during MB to get 2x playfield scoring for 20 seconds. Hit Groot again and re-lock another ball in Groot's mouth during MB to get 3x playfield for 20 seconds. When balls release from Groot's mouth, a temporary ballsaver will save balls that drain straight from the release. Up to three balls can be locked this way per Groot MB, so you can either have one 2x->3x period and a separate 2x period, or three separate 2x periods. These multipliers can be combined with all other **[multipliers](#heading--pfx)** in the game.
...
* Advance pops
* Big points (10M)
* Spot **[RAMPAGE](#heading--rocket)** letter
* **[Orb Multiball](#heading--orb)** lock
...
### Extra Balls {#heading--eb}
Extra Ball lights at the scoop when 3 of the game's 10 main **[modes](#heading--modes)** or **[multiballs](#heading--multiballs)** have been started, and again after 6 modes have been completed.

If disabled, Extra Ball scores 15M and can be increased by all **[multipliers](#heading--pfx)** (excluding **[Nova Corps](#heading--nova)** and combo multipliers). Therefore, 75M can be scored as the max extra ball compensation value.

### End-of-Ball Bonus {#heading--bonus}
Bonus is calculated from 1k per major shot made this ball + 10% of the total score of every **[mode](#heading--modes)** *completed* so far, over the course of the game. The bonus multiplier increases every time the **[mystery award](#heading--mystery)** is lit by spelling GUARDIANS.

## Wizard Modes {#heading--wizard}
### Cherry Bomb Multiball {#heading--cherrybomb}
Complete 4 **[modes](#heading--modes)** (excluding **[multiballs](#heading--multiballs)**) to light the right scoop for Cherry Bomb Multiball. Shoot the red-pulsing right scoop to start it.

This is a 6-ball, 60 second unlimited ball-save Multiball where all shots are flashing to score 3M (+100k per subsequent flashing shot). Shooting a flashing shot lights it solid; subsequent hits are worth 1M. When all 9 flashing shots are completed, shoot into the moving-mouth Groot to score a super jackpot worth the jackpot total and re-light all of the flashing shots. **[Hadron Enforcers](#heading--hadron)** ignore solidly lit shots and only spot pulsing shots, and *cannot* be used for the super jackpot. Balls are plunged fully around the orbit (not to the upper lanes).
