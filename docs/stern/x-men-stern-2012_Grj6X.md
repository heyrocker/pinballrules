---
title: "X-MEN (Stern 2012)"
discourse_topic_id: 8599
manufacturer: "Stern Pinball"
opdb_id: "Grj6X"
source: https://tiltforums.com/t/x-men-stern-2012/8599
---
...
* +9X Bonus
* Pops Grow
* Shot Awarded (during villain modes)
* Hold Bonus
* Ball Save
* Hold Bonus X
* +25X Bonus
...
The second Blackbird completion will light Villain mode start.

Shooting into the scoop when Villain is lit will display a screen where you pick which villain to battle. Use the flippers to move over the villain you want to face and press both flippers to start the mode or wait until the 10 second timer counts down.

When a villain mode is running, you can only complete the rollover lanes for another Mystery award.

Thereafter, two Blackbird lane completions will light mystery and two more completions will light Villain.

If you have qualified either the Hellfire or Brotherhood villain modes via their respective targets, they will be lit and hitting either target will light the Villain for Mystery without having to complete the Blackbird lanes. If you choose not to start the Hellfire or Brotherhood multiballs villain modes that you have qualified, the ability to shoot the Hellfire or Brotherhood targets to relight the villain mode remains after exiting the villain mode.
...
Shoot unique hero combos for a special callout. You won’t see/hear these when a Hero mode is running but there are still collectable and you can check the number you are at in the Instant Info screen. The first unique combo does not increases the base combo value but every unique combo after that increases the base combo value by 50k. Shooting 10 different unique combos will light an extra ball.

* Beast → Xavier “Sharp minds!” - Beast
* Beast → Rogue “Beauty and the Beast” - Rogue
* Beast → Wolverine “Savage Animals”
* Beast → Storm “Meteorology” - Beast
* Cyclops → Xavier “Teacher’s Pet” - Cyclops
* Cyclops → Storm “Gold and Blue Leaders” - Cyclops
* Cyclops → Rogue “Power Drain” - Cyclops
* Cyclops → Wolverine “Rivals”
* Iceman → Xavier “Brain Freeze” - Iceman
* Iceman → Beast “Angry Yeti” - Iceman
* Storm → Iceman “Hailstorm!” - Storm
* Storm or Xavier → Phoenix → Wolverine “Unrequited Love” - Phoenix
* Storm or Xavier → Phoenix → Iceman “Fire & Ice” - Phoenix
...
Deadpool is switch based. Deadpool helps you by advancing towards a goal in the villain mode that you would normally accomplish with the lit red arrow shots. The game keeps track of an internal Deadpool counter and advances the counter by 3 for every switch hit and by 1 for every pop bumper, and once 36 is reached, Deadpool is called. Usually you will see a DMD animation that says "Deadpool has helped you!", and Deadpool will say one of his many sarcastic remarks, as is his character. The Cyclops' spinner could help MELT through villain modes because each spinner switch hits adds up quick.

Deadpool is active until you either beat a villain or drain the ball. So if you time out of a villain mode, but don't beat the villain, he will still be available for your next villain fight, assuming that you don't drain the ball. After you beat the villain or lose your ball, Deadpool is gone and you must "re-hire" him. If you know that you have a final shot left on a villain, if you have a choice, it would be beneficial to not have Deadpool running when you finish that villain mode and utilize Deadpool in a villain that you haven’t made progress in.
...
* LE
  * Hit big pop-up targets that block the ramps a number of times for points. Pop-up targets shift every few seconds.
* Pro
...
Hitting Magneto at the lock awards 50k points, but, more importantly, recharges the Hero shots that correspond to the Hero modes that you have started. All Hero shots do damage to Magneto initially, but started Heroes do more damage. If you start Magneto with one or two heroes, the Magneto lock will do more damage to Magneto than the heroes that you have started. So, the more heroes you bring in, the greater the chance you will complete Magneto. Typically, it will take 10-12 lit shots to lower Magneto’s damage to zero.
...
* Shooting the armed boss shots are worth 900k plus 100k for each previous Wolverine
completion.
...
* Left shots value
  * 300k for the 1st shot
  * 500k for the 2nd shot
  * 700k for the 3rd shot
  * 900k for the 4th shot
  * 1.1M for the 5th shot
* Right shots value
  * 300k for the 1st shot
  * 450k for the 2nd shot
  * 600k for the 3rd shot
  * 750k for the 4th shot

If the number of right shots exceeded the number of left shots, the final shot has a base value of 4.5M plus a bonus of 150k for each right shot. Otherwise, the final shot has a base value of 4.5M plus a bonus of 200k for each left shot.

If you didn’t finish Sabretooth, damage progress is saved but shots progress is not. So, if you have only two shots of damage left when you restart Sabretooth, the first left shot and first right shot will be worth 300k and the final shot would be worth 4.7M.
...
If you are unable to complete Juggernaut, the jackpot value is reset to zero on the next Juggernaut mode start, and damage progress is saved.
...
This is a mode where you must destroy the lasers, flamethrowers, and electronic tentacles shooting at you. Advancing levels will increase the balls in play. You can still be in the Danger Room mode with one ball in play. The red shots and character inserts on the playfield correspond to the lasers that are to be destroyed.

On the first level, Beast, Phoenix, and Magneto shots are lit for 2M. Completing those shots lights the Blackbird shot for 2M and the next level starts. The second level is a two-ball multiball and Beast, Xavier, Magneto, Iceman, and Phoenix shots lit for 3M, with a final shot at the Blackbird for 3M. The third level is a three-ball multiball and Hellfire, Beast, Xavier, Magneto, Iceman, Phoenix, and Brotherhood targets are lit for 4m, with a final shot at the Blackbird for 4M.

The final level is a four-ball multiball battle with Danger, the android embodiment of the artificial intelligence that is the Danger Room. Storm, Rogue, Xavier, and Iceman are lit for 4M, 6M, or 8M and the Brotherhood and Hellfire targets are lit for 1M. Danger does not have a damage meter.
...
* Make sure you light the Launch lanes as many times as possible. Every time a ball comes down a ramp return, concentrate on lining up the Launch lights so that you can collect one of them.
* Shoot for the Brotherhood and Hellfire clubs, but don't start actually these modes until you've completed the other villains. Once you qualify BH and HFC, it only takes one shot to the respective targets to relight the villain light (as long as you don't start that MB). This is the quickest way to relight the villain light.

Try to take a villain into Weapon X MB or Magneto MB. This can be just as useful for beating them as Deadpool (almost, anyway).

Generalized villain ranking without Deadpool:

* Hardest:
  * Shadow King is the hardest for me. Even with Deadpool, you still have to make the final shot to Xavier yourself (Deadpool generally doesn't make final shots). Xavier is the hardest shot on the board for me.
  * Omega Red. Not as hard as Shadow King, but can be tough. Much easier with Deadpool.
* Medium:
  * Juggernaut. I usually fight Jugs without Deadpool, but only because he is easy right up to that last shot to Xavier.
  * Hellfire Club. Definite Deadpool Candidate, but can be done without.
  * Brotherhood. Another Deadpool Candidate, but also can be done without.
* Easiest:
  * Sentinels. Not very hard because you can shoot any shot. I like to start them with Magneto. I rarely waste a Deadpool on them.
  * Sabretooth. Shoot a few combos and he's done. Don't really need Deadpool, but sometimes I'll start him with Weapon X.