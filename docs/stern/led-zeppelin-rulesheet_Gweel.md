---
title: "Led Zeppelin Rulesheet"
discourse_topic_id: 6878
manufacturer: "Stern Pinball"
opdb_id: "Gweel"
source: https://tiltforums.com/t/led-zeppelin-rulesheet/6878
---
...
- [Song Modes & Records](#heading--songmodes)
  - ["Change Song"](#heading--changesong)
- [Tour Modes](#heading--tourmodes)
  - [Tour Multiballs](#heading--tourmb)
- [Main Multiballs](#heading--multiballs)
  - [Zeppelin Multiball](#heading--zeppelin)
  - [Electric Magic Multiballs (Prem / LE Exclusive)](#heading--electricmagic)
- [Other Scoring](#heading--other)
  - [Target Banks](#heading--targets)
  - [Combos & Icarus X](#heading--icarusx)
  - [Band Boosts (Action Button)](#heading--bandboosts)
  - [Zeppelin Awards](#heading--hermit)
  - [Extra Balls](#heading--extraballs)
  - [End-of-Ball Bonus](#heading--bonus)
- [Wizard Modes](#heading--wizard)
  - [Mothership Multiball](#heading--mothership)
  - [World Tour Multiball](#heading--worldtour)
  - [Top of the Charts Multiball](#heading--topofthecharts)
  - [?](#heading--celebrationday)
...
## Song Modes & Records: {#heading--songmodes}
Song modes are chosen at the beginning of every ball and run continuously throughout the ball, even during **[multiballs](#heading--multiballs)** and **[wizard modes](#heading--wizard)** (excluding **[Top of the Charts](#heading--topofthecharts)**), until the song has ended. When a song ends, that song mode ends, and the next song and song mode on the list at the back of the game will start playing.

Your goal during each song mode is to collect 5 gold **records** to complete the song, and/or go platinum by collecting 10 gold records. Completing the song lights the right orbit for "Change Song" and scores **[Band Boosts](#heading--bandboosts)**. Record sales are collected by keeping the ball moving and shooting the lit arrows that change with different musical sections of the song. Each 100,000 record sales awards 1 gold record. White "cue" lights will blink briefly between sections to show you where the next shot is prior to the section change, and each lit shot made - and record earned - adds to the values for subsequent shots. The sequences, and lengths, for each song mode are listed below:
...
- Section 1: Left orbit & right orbit lit. Shooting shot on left moves it right one and shooting shot on right moves it left one. Once both shots have converged, hitting the shot will start an 8 second timer. Each hit to the converged shot resets the timer. Once the timer expires, the shots diverge apart. Your shot status at the end of Section 1 is remembered on returning to it after Section 2.
- Section 2: All shots
...
Completing five songs qualifies **[Mothership Multiball](#heading--mothership)**, completing all 10 songs qualifies **[Top of the Charts](#heading--topofthecharts)**, and going platinum during all 10 songs qualifies **[?](#heading--celebrationday)**, all started at the right orbit.
...
## Tour Modes: {#heading--tourmodes}
Tours are started at the left eject when the green arrow is flashing. Qualify a new tour by shooting the right ramp an increasing number of times (+1 for each additional tour, by default), except during **[wizard modes](#heading--wizard)**.
...
Play all four Tour Multiball modes to qualify **[World Tour Multiball](#heading--worldtour)** at the left eject.
...
- On the Prem / LE models, completing the LED and ZEP target banks lights all major shots to qualify the **[Electric Magic spinner](#heading--electricmagic)**.
- Completing the ROCK target bank qualifies the locks for **[Zeppelin Multiball](#heading--zeppelin)** if they aren't lit.
- Completing all four target banks lights **[Icarus X](#heading--icarusx)** at the center Icarus target bank.

### Combos & Icarus X: {#heading--icarusx}
Collect **combos** by shooting lit combo shots in quick succession, and increase their values by completing target banks. While the combo inserts are lit, hitting any of the four **target banks** on the playfield - whether lit or unlit - will "complete" the combo, or you can use a **[Band Boost](#heading--bandboosts)** to complete it instantly. Completing a combo ends the sequence and increases the target bank's multiplier by +0.1x times the length of the combo.
...
### Band Boosts: {#heading--bandboosts}
**Band Boosts** are an easy way to complete **[combos](#heading--icarusx)** and are used by pressing the action button when flashing green. Each game starts with 1 Band Boost qualified, and more can be earned by completing or changing **[song modes](#heading--songmodes)**. Up to 5 Band Boosts can be saved at a time, and saving up 3 will enable Super Band Boost (flashing red). During single-ball play, Band Boost will instantly award 5x the current combo value and complete it at the target bank with the lowest current multiplier; while Super Band Boost awards 10x the current combo value and completes the combo, albeit adding the multiplier to 2 of the target banks (the two lowest) instead of just one. Band Boost spots a hit to the Icarus target during **[multiballs](#heading--multiballs)**, while Super Band Boost instantly adds a ball.
...
- **Super Ramps**: For 10 ramp shots, if any of the three ramps are lit during a **[song mode](#heading--songmodes)**, shooting the lit ramp will score 2x the value of the song award. Goes away upon draining the ball.

Side flipper shots also add 5 seconds to the **[Icarus X](#heading--icarusx)** timer. Collecting 8 Zeppelin Awards lights the left eject for **[extra ball](#heading--extraballs)**.

### Extra Balls: {#heading--extraballs}
5 Extra Balls are available on default settings, and can be collected at the left eject after:
- Collecting 5 **gold records** during a **[song mode](#heading--songmodes)**
- Completing 4 **songs**
- Starting 2 **[Tour Multiballs](#heading--tourmb)**
- Scoring 8 **[Zeppelin Awards](#heading--hermit)**
- Collecting 5 City Jackpots during **[World Tour Multiball](#heading--worldtour)**
...
- 50k + 50k per combo made that ball
- 25k per gold record (for the game so far)
- 1M per platinum record (for the game so far)

## Wizard Modes: {#heading--wizard}
### Mothership Multiball: {#heading--mothership}
After completing 5 **[songs](#heading--songmodes)**, the next shot to the right orbit that lands in the eject will begin Mothership Multiball. Mothership Multiball is largely influenced by the currently active **song**, as this is used to determine jackpot shots:
