---
title: "World Poker Tour Rulesheet"
discourse_topic_id: 3858
manufacturer: "Stern Pinball"
opdb_id: "G5poe"
source: https://tiltforums.com/t/world-poker-tour-rulesheet/3858
---
...
- [Poker Corner Modes](#heading--pokercorner)
- [Side Pots](#heading--sidepots)
- [Multiballs](#heading--multiballs)
  - [Ace in the Hole Multiball ](#heading--aceintheholemb)
  - [All-In Multiball](#heading--allinmb)
  - [No Limit Multiball](#heading--nolimitmb)
...
- [Cut the Cards](#heading--cutthecards)
- [Hurry Ups](#heading--hurryups)
- [Other Features](#heading--otherfeatures)
- [Wizard Modes](#heading--wizardmodes)
  - [Poker Wizard](#heading--pokerwizard)
  - [WPT World Championship](#heading--wptworldchamp)
  - [Keefer Invitational](#heading--keeferinvitational)
...
Every mode has a "goal" (usually making a certain amount of shots). Completing the goal awards a Trophy. Each Trophy scores 1M and increases the value of the Poker Wizard mode. Poker Corner modes last 30 seconds; if there's still time left, the first award from Cut the Cards will add 15 more seconds.

Modes cannot be started during multiballs, but you _can_ start Ace in the Hole, All In, and No Limit Multiball during a mode. Drop Target Poker is available during every mode except Know Your Outs and Chip and a Chair.
...
* **Play the Button:** One flashing arrow (the button) is worth a large value starting at 500K, while all other unlit shots start at 50K. Hitting a shot adds 100K to the flashing shot value, and 10K for the unlit value. Once any shot is made, the flashing shot moves to the leftmost shot on the playfield. Make three flashing shots to earn a Trophy.

* **Know Your Outs:** Drop targets score 250K + 25K per subsequent drop, to a max of 750K per drop target. Drop targets stay down until all 16 of them have been hit, upon which they all reset; this also awards a "drops complete" bonus worth 1M + 500K for each time all 16 drop targets have been hit. Hit 16 drop targets to earn a Trophy.

* **A Chip and a Chair:** Each drop target scores 100K +10K per drop target hit, and immediately resets. Hit 20 drop targets to earn a Trophy.

* **Spot the Tell:** The DMD shows six faces, each corresponding to the six main shots on the lower playfield. Occasionally, a face will show a tell. Hitting the corresponding tell shot awards 1M + 250K per tell found, relights all shots, and randomly selects a new tell shot (which could be on the same shot). "No tell" shots score 100K + 25K per shot. Find two tells to earn a Trophy.

* **Change Gears:** Hit shots on the lower (any of the 6 main shots) and upper playfield (white stand ups). Shots on the lower playfield start at 500K, shots on the upper playfield start at 300K, each will increase both, +50K for Low gear and +25K for high gear.  Low Gear shots max out at 1.5M, High Gear shots max at 750K. Hit 8 shots to earn a Trophy.
...
### Keefer Invitational {#heading--keeferinvitational}
This final wizard mode is qualified by winning the WPT World Championship and scoring  25 million in each of the following:
