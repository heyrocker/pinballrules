...
discourse_topic_id: 10102
manufacturer: "Stern Pinball"
opdb_id: "Gj6DE"
source: https://tiltforums.com/t/the-walking-dead-remastered-rulesheet/10102
---
...
**Woodbury** uses the three rollovers and two top lanes that are also part of the **[skill shot](#heading--skillshot)**. Multiple awards are shown on the display including 10k, 100k, 1M and two features awards. The left flipper changes which rollover will give an award, while the right flipper changes which awards are lit at which rollover. The player must complete the lit rollover or lane within 5 seconds of plunging the ball to collect the award. 
...
When Escape is available, the next ball that drains down an outlane lit for it will be saved.
### Extra Balls: {#heading--extraballs}
...
### End-of-Ball Bonus: {#heading--bonus}
Bonus is calculated as 50k x **[Walkers](#heading--walkers)** defeated over the course of the game x the bonus multiplier, which increases by +1x to a maximum of 250x with every top lane completion.
