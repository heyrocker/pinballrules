...
- [Character Select](#heading--characters)
...
Winning two missions lights the left ramp for **[extra ball](#heading--extraball)**. Attempting all four final multiball modes is required to qualify the final wizard mode, **[Jedi Multiball](#heading--wizard)**. After a mode is completed, it can only be played again after the wizard mode has ended.
 ...
 - **Death Star**: Shoot the left mini-loop to light these modes.
   - *I: Rescue the Princess* (Luke | Leia | R2 | Han) - Complete 4 hurry-up shots at the left orbit, both sides of the mini-loop, and the right ramp. Base value of the first hurry-up is 2M and reach subsequent hurry-up is worth the (multiplied) value of the previous plus 2M. Caps at 25M. [:arrow_forward:](https://youtu.be/Oc_gipo7Bls?t=24828)
   ...
   - *III: Fight TIE Fighters* (Luke | Han) - Shoot any of the flashing purple shots (all major shots) to light the TIE Fighter target for about 10 seconds. Shoot the lit TIE Fighter target four times to win.
   - *Final: Destroy the Death Star* - Shoot the ramps to light a 10-second hurry-up at the left mini-loop to deal damage to the Death Star. Collect three hurry-ups, increasing in value for each successful collect, to destroy the technological terror that the Empire has constructed and start **[Victory Multiball](#heading--victorymb)**.
...
- **Endor**: Shoot the left ramp to qualify and start these modes.
   ...
   - *Final: Battle Above Endor*: To destroy the Death Star, you need to first light the left mini-loop by completing three other shots before the timer runs out. Each shot will start a timer for the next shot, which can be increased by shooting the 3-bank of standup targets. If the timer runs out, the Death Star will destroy a Capital ship and an additional 3 shots must be made. Once the inner left loop is lit, shoot it to destroy the Death Star and start **[Victory Multiball](#heading--victorymb)**.

- **Hoth**: Shoot the right mini-loop to qualify and start these modes.
  - *I: Navigate the Asteroid Field* (Leia | Han) - Another way to start the **[Video Mode](#heading--videomode)**. If Video Mode was lit via the **[FORCE targets](#heading--force)** and this mode was selected, the video mode will be advanced a level as compensation.
  - *II: Cloud City Escape* (Leia) - Shoot both ramps, then both orbits. The right mini-loop will light to complete the mode on a 10-second timer for the total value, but draining or waiting until the timer runs out will also finish the mode.
  ...
  - *III: Repair the Hyperdrive* (R2) - Shoot any blue shot to light the left mini-loop for a hurry-up; collect the hurry-up to win the mode.
  ...
  - *Final: Escape from Hoth* - Shoot the left orbit 3 times to prepare the ion cannon, then make any shot to the 3-bank to fire it; shoot either mini-loop 4 times to take down the AT-AT Walker with a tow cable. After completing both tasks, which run concurrently, shoot the last two ramp shots to escape from Darth Vader, then the right loop to start **[Victory Multiball](#heading--victorymb)**.
...
- 2nd Completion: **[Light Escape](#heading--escape)**
- 3rd Completion: **[Light Video Mode](#heading--videomode)**
...
Each Jedi Training level advanced also completes a set of **[FORCE targets](#heading--force)**.
...
- Complete **[Lightsaber Duel](#heading--duel)**
- Complete **[Escape from Boba Fett](#heading--boba)**
- **[Destroy 100 TIE Fighters](#heading--ties)**
- Start all four **[final planet multiball modes](#heading--planets)**

Before Jedi Multiball begins, you will receive bonus points based on how many medals (if any) you acquired during **[Victory Multiball](#heading--victorymb)**. This can often be higher scoring than the multiball itself!
...
Win or lose, you will return to the **[character selection screen](#heading--characters)**, where you must pick a different character to start another loop of the game. There is no "super wizard mode" for completing Jedi Multiball with all four characters; if you manage to reach this point, the four characters will simply be unlocked again. As of more recent code updates, multiple characters will be counted separately for the character champion high score entries.  (On old code, only your last-played character will be recorded.)