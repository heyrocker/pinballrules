...
* [Razor Crest Multiball](#heading--razorcrest)
...
- Shoot the left ramp enough times to light and then start an Encounter, these are played on the upper playfield (Prem/LE) or upper playfield area (Pro).
- Playfield Multipliers can drastically boost the game's scoring potential. There are 3 different +1x playfield multipliers available in the game, getting all 3 going gives a total boost  of +5x playfield for a 6x playfield.
   - Hit both Boba Fett Targets to start +1x, and to add time to the playfield multiplier timer. This is the only one that can be **started** during a multiball.
   - Complete Scope to start +1x.
   - Complete Hunter to start +1x.
      - You can also spot these playfield multipliers at the Foundry by spending Beskar and (as of v1.40) from Ambush.
- You can collect Equipment to get specific perks or enable certain features by spending Beskar at the Foundry, from Scope, from Ambush, and as a Child Mystery Award.
   - Flamethrower starts lit at the beginning of a game and is used to light the main shots with a one time use 2x shot multiplier.

### Quick Strategy Guide

- Stacking a Mission with a Razor Crest Multiball can score some quick, relatively easy, and relatively safe points.
- Getting **any** playfield multipliers going can drastically boost your scoring.
- Use the Flamethrower to double the value of your next shots, specifically when you have a single shot that is worth a lot of points (like with Jet Pack Multiball's Super Jackpot) or when you have lots of shots lit for decent points and/or when the value of those shots builds the value of another shot (like with the other two Multiballs).
- **"The Fire Triangle"**:
   - The basic idea is to get all of your playfield multipliers going and then play a multiball. Scope needs to be completed and Hunter needs to be started, but ideally completed, before multiball starts. The Boba Fett playfield multiplier can be started after multiball starts.
   - With Ice Spider Multiball or Pirates Multiball running, once you also have all of the playfield multipliers running, activate the Flamethrower for all of the shots to make each shot worth 12x the base value for 1 shot, then back to 6x as long as you keep the timer going. This will also build your Super Jackpot value where you can score even further big points.
   - With Jetpack Multiball, the Super Jackpot is being built during the Multiball but can't be collected until you're back in single ball play. You want to max out the base Super Jackpot value to 50M while keeping all of your playfield multipliers active, and then use Flamethrower before collecting the Super Jackpot in single ball play for 600M.
...
**Regular Skill Shot:** The ball falls into the CHILD top lanes area by default. A strong shot will always fall through the "C" lane, so either time your plunge accordingly or nudge the ball through either of the two cycling lit lanes. Skill shots award 1 million points (+1M per skill shot) and these awards:
  ...
  * +1 **[Super Pops](#heading--superpops)** bumper
...
**Super Skill Shot:** Hold in the left flipper until the ball passes the C lane to light the super skill shot sequence: U-Turn to right ramp to one of three final shots, within 5 seconds per shot. Each final shot gives a different award:
   * Left scoop - Starts currently lit **[Mission](#heading--missions)**.
...
After playing a multiball, the Razor Crest can be relit to start Razor Crest Hurry-Up by completing a **[Hunter](#heading--hunter)** mode. The Razor Crest also relights when the ball drains, if it isn't currently lit. Playing all three multiballs in a single game qualifies **[Precious Cargo](#heading--miniwizards)** as the final Razor Crest award. Every Super Jackpot scored during multiball adds 2.5 million to **[end-of-ball bonus](#heading--bonus)**.
...
* Scoring the U-Turn during **[Scope](#heading--scope)** (two random unqualified equipment)
* **[The Child's mystery award](#heading--child)** (two random unqualified equipment)

The five pieces of equipment are:
* **Flamethrower (Orange):** As the Mandalorian's most trustworthy weapon, one use of the Flamethrower is given at the start of every game. Hold the action button to light all main arrow shots on fire from the right to the left of the playfield; if you let go before the flames get to the left orbit, then you lose the opportunity to light those shots on fire. Your next shot to each "flaming" shot will score 2x for all associated points for that shot, and will extinguish the fire on that shot. Flaming shots can be made at any time, but disappear when the ball drains. You can also collect the Flamethrower by choosing to continue the **[Ambush](#heading--ambush)** mode twice.
* **Amban Rifle (Green):** Press the action button to add-a-ball to any multiball mode, **[Razor Crest](#heading--razorcrest)** or otherwise. The action button only lights green once the initial ball save timer has run out.
* **Whistling Birds (Yellow):** Press the action button to instantly collect all flashing shots during a **[mission](#heading--missions)**. This also collects lit jackpots during multiball modes and is affected by the Flamethrower multiplier.
...
* Completing a **[Hunter](#heading--hunter)** mode (minimum of 250 Beskar)
* Scoring the left 2x target during **[Scope](#heading--scope)** (200 Beskar)
* **[The Child's mystery award](#heading--child)** (300 to 400 Beskar)
...
| --- | --- | --- | --- |
**[Armor](#heading--equipment)** | Extended ball save times (including multiballs) | 200 | Max. 1
**[Whistling Birds](#heading--equipment)** | One-use "smart bomb" for missions, CHILD mystery, multiballs | 175
**[Rising Phoenix (Pro) / Jet Pack (Prem / LE)](#heading--equipment)** | Action button immediately completes current Encounter level (Prem / LE - levels mini playfield) | 175
**[Flamethrower](#heading--equipment)** | One use of the Flamethrower at the action button | 175
**[Amban Rifle](#heading--equipment)** | Multiball add-a-ball | 175
**[Start Mission](#heading--missions)** | Immediately starts the currently lit mission | 175
**[Razor Crest](#heading--razorcrest)** | Immediately lights next multiball or hurry-up | 300
**[Light Encounter](#heading--encounters)** | Immediately lights next Encounter | 100
**[Light Scope](#heading--scope)** | Lights left inlane for Scope | 75
Light Heal | Lights outlane ball saver | 200
**[Extra Ball](#heading--extraballs)** | Lights extra ball at the left scoop | 600 | Max. 1
**[Multiplier](#heading--pfx)** | +1 playfield multiplier | 500
...
* **[Light Ambush](#heading--ambush)**
* **[Start Hunter](#heading--hunter)**
* Start **Dank Farrik!** (2-ball multiball, all switches score 10,000 + 1,000 per every switch threshold and an intergalactic curse word)
* Light all three +1x **[playfield multipliers](#heading--pfx)** (!)
* Light **[Child](#heading--child)**
...
- Left 2x target - 200 **[Beskar](#heading--foundry)**.
...
* **[Equipment](#heading--equipment)**
* 300 - 400 **[Beskar](#heading--foundry)**
* **[Super Pops](#heading--superpops)**
* **Super Spinner**
* +1 **[Playfield Multiplier](#heading--pfx)**
* Light Heal
* Increase **[Ambush](#heading--ambush)** Value +2,000,000
* +1x - +3x **[Bonus Multiplier](#heading--bonus)**
* 2,500,000
...
* Orange - 75 seconds. Awarded by successfully completing a **[Hunter](#heading--hunter)** mode.
...
- Scoring a Super Jackpot during any **[Razor Crest Multiball](#heading--razorcrest)**
- Completing an **[Encounter](#heading--encounters)**
- Collecting a **[Scope](#heading--scope)** award
...
- Two of the Scope shots (either U-turn, left 2x, or right ramp)
- Both Hunter shots (left orbit and right orbit)
- Ambush shot (right ramp)

If "Mission" isn't lit at the left ramp, shooting it will send the ball to the Encounter playfield. Complete all six targets there to add +1x to the **[playfield multiplier](#heading--pfx)**.
...
- Qualifying the next **[Razor Crest multiball or hurry-up](#heading--razorcrest)**
- Lighting the next **[Encounter](#heading--encounters)**
- Lighting **[Scope](#heading--scope)**
- Lighting **Heal** (outlane ball save)
- Lighting **[extra ball](#heading--extraballs)**
...
After completing three rounds of both phases, you will be awarded 10 million and your Signet. All missions, multiballs, and encounters will reset, and you will be awarded an additional **[playfield multiplier](#heading--pfx)** for the rest of the game.