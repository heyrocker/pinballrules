...
discourse_topic_id: 10092
manufacturer: "Stern Pinball"
opdb_id: "GV8wB"
source: https://tiltforums.com/t/pokemon-rulesheet/10092
---
...
- [Wizard Modes](#heading--wizard)
  - [Pikachu vs. Charizard (Mini-Wizard Mode)](#heading--charizard)
...
- Wiki Rulesheet based on Code Rev: 0.83
  - *Edit the Code revision, if applicable, when you make changes*
- Original Wiki Rulesheet hosted on [Tilt Forums](/stern/pokemon-rulesheet_GV8wB)
...
- **Squirtle Prize Pool**: Shoot the left ramp, then while the ball is being spun in the whirlpool, press the action button to score the selected prize pool award x2. Each whirlpool spin changes the award.
...
- **Team Rocket Multiball 2**: Battle the mecha-Meowth being powered by Vanillite and their evolutions. Hitting red shots will "freeze" them (turning them blue) and increase the jackpot multiplier. Hitting a "frozen" shot will decrease the jackpot multiplier, but increase the base jackpot value. The jackpot can be scored at the Meowth balloon after freezing a shot (+1 frozen shot per subsequent multiball).
...
Repeating this process, once for all four major shots, will light the center lane to win the battle and score a super jackpot hurry-up starting at the total of all shots made up until the center lane was shot. The maximum value of this hurry-up is 100M (200M with **[2x playfield](#heading--berries)** active).
