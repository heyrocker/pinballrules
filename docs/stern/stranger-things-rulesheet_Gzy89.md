...
* The **saucer, standup/mystery lane, middle (behind drops), and right orbit** can only be the last shot in the combo as they will end the combo
...
* **[+2 Drawings](#heading--drawings):** Find Barb on the first shot.
...
* **[+2 Drawings](#heading--drawings):** Shooting the four shots preceding the final shot in this order: right ramp, left ramp, right orbit, left orbit.
...
* **[+2 Drawings](#heading--drawings):** Completing the chapter while only shooting the drop targets (5 sets). The center shot behind the drops can only be shot when it's the final shot.
...
* **[+2 Drawings](#heading--drawings):** Making a **[5-Way Combo](#heading--5way)** during the chapter using only the ramps.
...
* **[+2 Drawings](#heading--drawings)** by advancing through all four levels.
...
* **[+2 Drawings](#heading--drawings)** by completing the entire mode as a combo
...
* **[+2 Drawings](#heading--drawings)** by only shooting flashing shots.
...
* **[+2 Drawings](#heading--drawings)** by finishing the chapter with only shots to the right orbit. *Note: Starting this mode from the left standup/mystery lane tends to disqualify you from collecting 2 drawings b/c it hits the spinner on the way down.*
...
* **[+1 Drawing](#heading--drawings)** awarded for completing phase 3
...
* **130 pops (+40)** - +1 **[drawing](#heading--drawings)** (22k per pop)
...
- Starting 6 **Chapters**
- Scoring between 2 to 10 **[Burn it Back](#heading--burnitback)** loops (percentage-based)
...
- **[Demodog Attacks](#heading--demodog)** started x 5M
- **[Telekinesis Multiballs](#heading--tk)** started x 3M
- 10% of all points scored during **[Chapters](#heading--chapters)** this ball
- **[Drawings](#heading--drawings)** collected x 2M
