---
title: "Toy Story 4 Rulesheet"
discourse_topic_id: 7707
manufacturer: "Jersey Jack Pinball"
opdb_id: "GJ2o0"
source: https://tiltforums.com/t/toy-story-4-rulesheet/7707
---
...
- [Scenes](#heading--scenes)
  - [Road Trip Multiball](#heading--roadtripmb)
  - [Buzz Quick Multiball](#heading--buzzmb)
  - [Rescue Forky](#heading--forky)
  - [Carnival Modes & Tickets](#heading--carnival)
    - [Carnival Multiball](#heading--carnivalmb)
  - [Super Spinners](#heading--spinners)
  - [Duke Caboom Jump](#heading--duke)
  - [Bo Peep Loops](#heading--loops)
- [Take A Chance Wheel](#heading--chance)
   - [Gabby Gabby Frenzy](#heading--frenzy)
   - [Caboom](#heading--jumps)
   - [Unlimited Kickback](#heading--kickback)
   - [Super Loops](#heading--superloops)
   - [Super X](#heading--superx)
   - [Tiki Party Pinball](#heading--tiki)
   - [Hold Bonus X](#heading--holdbonus)
   - [Light Extra Ball](#heading--lighteb)
- [Other Scoring](#heading--other)
  - [Gabby Gabby Multiball](#heading--gabby)
  - [Hurry-Up](#heading--hurryup)
  - [Super Jets](#heading--jets)
  - [Mystery](#heading--mystery)
  - [Extra Balls](#heading--extraballs)
  - [End-of-Ball Bonus](#heading--bonus)
- [Take A Chance Multiball (Mini-Wizard Mode)](#heading--chancemb)
- [Meet Me at the Carousel (Wizard Mode)](#heading--wizard)
...
* **Skill Shot:** Plunge the ball so that it enters the Woody saucer to score a skill shot. Making the skill shot awards 50 **[tickets](#heading--carnivalmb)**, 50,000 points (+10,000 points per subsequent skill shot), and increases the **[bonus multiplier](#heading--bonus)** by +5x (+5x per subsequent skill shot).
...
Make three skill shots in a game to light the **[extra ball](#heading--extraballs)**.
...
The plot of ***Toy Story 4*** is conveyed through seven scenes that the player simply has to start to gain access to the wizard mode, **[Meet Me At The Carousel](#heading--wizard)**, though completing certain tasks during each objective adds score multipliers to the wizard mode. The player must complete the wizard mode twice during a single game, once for both Woody and Buzz’s paths, to fully complete the game.
...
The lockup is lit to add balls an unlimited amount of times until the first Mega Jackpot is scored. After scoring the Mega Jackpot, balls can no longer be added.
...
### Carnival Games & Tickets: {#heading--carnival}
Shoot the ramps to score **tickets** shown on the numbered inserts below the Duke Caboom jump ramp. After collecting enough tickets, shooting the left ramp when a carnival game is lit spends your tickets and starts one of twelve carnival games that can be changed using the left flipper. Certain games cost more tickets than others, though the first game doesn't require any tickets. Each game has a timer that lasts 40 seconds, which can be extended by +5 seconds by shooting the scoop after making any lit shot.

***Note:** Unlocked carnival games increase in difficulty after every two modes played, generally adding more shots or increasing the requirements on spinner turns. Only 8 carnival games can be played per Carnival Multiball attempt.*

* **Flipball**: Cyan/green shots. Shoot the left ramp a certain number of times (4 minimum, 8 maximum).
* **Hypnosis**: Purple/green shots. Alternate between FORKY targets and left ramp / right ramp shots.
...
* **Star Adventurer**: Purple/yellow shots. Certain shots are lit at a time (targets, spinners, ramps, etc.). Shoot lit shots to advance mode.
* **Dragon Zone**: Purple/orange shots. Alternate between flashing FORKY or standup targets and lit shots.
* **Hammer Time**: Yellow/blue shots. Shots scroll between lockup + right ramp, left ramp + Woody spinner, and upper loop + captive ball. Shoot lit shots to advance mode.
* **Thrillipede**: Red/green shots. Shoot right ramp, then left ramp, then Woody spinner, then upper loop (1, 2 or 3 times based on difficulty). Make all shots as a combo for a bonus.
* **Pop Darts**: Shoot lit green/yellow shots to advance. The bumpers advance mode progression for every 4 bumper hits scored.
* **Zoetrope**: Red/yellow shots. Alternate between upper loop shots and other shots on the playfield.

After winning any carnival game, and while the timer is still running, the left ramp will light for **character collect** and the lighting / music will change to indicate this. Making this shot ends the game in success, rewards a bonus of (100,000 x number of games won) + (5,000 x seconds remaining), and collects a character. Each character adds a perk to the following **[Carnival Multiball](#heading--carnivalmb)**, which can include:

* Long ball save (1st award)
* Auto restart (instantly resets Carnival Multiball after a drain) (2nd award)
* Targets / spinners / bumpers increase jackpots (3rd award)
* 1x counts as 2x / 2x counts as 3x / 3x counts as 4x Jackpots (4th award)
...
* 3x Supers
* Frenzy!!! (all switches add points, collect at jump ramp)
...
All switch hits during Carnival Multiball add to the popcorn meter shown on the screen above the left ramp. Once the meter is completely full, the captive ball will light for Popcorn Jackpot, a hurry-up starting at 500k (+100k per popcorn jackpot scored) - you'll know it's lit when the lighting turns yellow / white. Scoring the Popcorn Jackpot *completes* the scene, and multiple Popcorn Jackpots can be collected within the same multiball.

If the jump ramp is lit for a super jackpot, shoot two balls up the ramp in quick succession to score Ducky & Bunny's double trouble jackpot, worth 2x the super jackpot value and awarding the super jackpot in the process.
...
Scoring **[Mystery](#heading--mystery)** during this mode will usually add time to the Super Spinners timer.

### Duke Caboom Jump & Caboom Jackpot: {#heading--duke}
Shooting the upper loop enables the left inlanes to lower the Duke Caboom jump ramp for a shot into the Star Adventurer stunt deck. The flashing Canadian maple leaf icon indicates whether or not the lanes will raise the jump ramp. The inlanes can also be lit for jump ramp loops by scoring **[Caboom](#heading--jumps)** off the **[Take A Chance Wheel](#heading--chance)**.

After jumping, if the jump ramp loop isn’t accessible, the right ramp will be flashing red. Shooting this shot lights the left ramp to continue building the Caboom Collect (+2x each time collected, exponentially increasing) and the lock-up to score the **Caboom Collect**. The Caboom Collect multiplier resets if the combo isn't scored, but increases to the base value are retained.

After scoring 10 jump ramps during normal play, the scene is *qualified*, and the next time the jump ramp is lit, the player can repeatedly shoot the jump ramp. Shooting the jump ramp 3 times in a row scores the **Caboom Jackpot** worth the total value built up from jump ramp shots, *completing* the scene.

Collect 8 jumps during normal play to light the **[extra ball](#heading--extraballs)**.

### Bo Peep Loops: {#heading--loops}
This scene can only be qualified or completed by starting the **[Super Loops](#heading--superloops)** mode off of the **[Take A Chance Wheel](#heading--chance)**. Once this has been played, collecting 15 upper loops will *qualify* the scene. Every further qualification of the scene requires 10 additional upper loop shots.

To *complete* the scene, during or after playing Super Loops, shoot 3 consecutive upper loop shots. This combo also scores a 100,000 point loop combo bonus even if it doesn't complete the scene.
...
For the next 30 seconds, *all* target hits or major shots will raise the Gabby Gabby target for a value that can be raised via further switch hits. Every Gabby Gabby target hit continues to advance towards starting **[Gabby Gabby Multiball](#heading--gabby)** as usual, and this mode can be stacked with other modes if it was activated before starting the other mode.

Scoring **[Mystery](#heading--mystery)** during this mode will usually add more time to the frenzy.
...
Once started, for the next 30 seconds, all loop shots score points and increase the **[bonus multiplier](#heading--bonus)** by +1x. Starting this mode also enables the **[Bo Peep Loops](#heading--loops)** scene to be qualified with 15 total loop shots over the course of the game, or completed via a 3-shot loop combo.

### Super X: {#heading--superx}
Started at the left target, which will be flashing rainbow colors once qualified.

2x playfield will be enabled for the next 30 seconds once Super X is started, but the playfield multiplier can be increased and +10 seconds can be added by rolling through the two left inlanes and shooting the jump ramp, up to a maximum of 4x playfield. Super X can be brought into other modes if started before activating the other mode.

Scoring **[Mystery](#heading--mystery)** during this mode will usually add +1x to the Super X.

### Tiki Party Pinball: {#heading--tiki}
Started at the left ramp, which will be flashing rainbow colors once qualified.
...
During Tiki Party Multiball, shoot the captive ball to spot lit red/orange shots and collect Jackpots. Jackpots start at 25,000 and increase with red/orange shot hits, Jackpots, and Super Jackpots. Once all red/orange shots are collected, the Super Jackpot is lit at the left ramp for 100,000 and **add-a-ball**. The Multiball increases in difficulty with each super jackpot scored, forcing the player to alternate between shots to light the captive ball jackpot.

### Hold Bonus X: {#heading--holdbonus}
Collected at the Woody saucer, which will be flashing blue/yellow once qualified.

Shoot the Woody saucer to hold the current end-of-ball **[bonus multiplier](#heading--bonus)** over to the next ball. If hold bonus X is scored on the last ball of a game, the total end-of-ball bonus will be *doubled*.

Individual elements of end-of-ball bonus can also be held via random **[Mystery](#heading--mystery)** awards.

### Light Extra Ball: {#heading--lighteb}
Collected at the scoop, which will be flashing rainbow once qualified.

If the wheel has landed on "Light Extra Ball", the next shot to the scoop will immediately award you with an **[extra ball](#heading--extraballs)**. However, if you change the wheel award by shooting the captive ball or the upper loop, you'll miss your chance and have to try again later!

## Other Scoring: {#heading--other}
### Gabby Gabby Multiball: {#heading--gabby}
The Gabby Gabby target raises for about 10 seconds at several times during the game:
- After shooting the jump ramp (once per jump ramp loop attempt)
- Making the jump ramp shot during **[Rescue Forky](#heading--forky)**
- Making any target or major shot during **[Gabby Gabby Frenzy](#heading--frenzy)**
...
### To Infinity & Beyond Jets: {#heading--jets}
Collect enough jet bumper hits and/or Inner Voice awards to advance through the Jet Sectors and light a jet bumper. Shooting the Warp target with a *clean* shot (ie. no bumpers were hit) will always advance a full Jet Sector.

After passing Jet Sector 4, To Infinity & Beyond Jets is enabled and all bumpers will be flashing for 30 seconds to add 250 points to the value for hitting the Warp target, which starts at 10,000 points. The timer pauses with every bumper hit, and the multiplier for the mode increases by +1x each time it is started during a game. Holding both flippers during To Infinity & Beyond Jets disables the warp target collect to allow for bigger values to be scored.

Scoring **[Mystery](#heading--mystery)** during this mode usually adds more time to the To Infinity & Beyond Jets timer.

### Mystery: {#heading--mystery}
Collect X switch hits to light the Second Chance store's mystery award at the scoop. Mystery awards include:

* **[Skill Shot](#heading--skillshots)** (awards the next skill shot value)
* Free **[Tickets](#heading--carnival)** X
* Hold X **[Bonus](#heading--bonus)** (Ball Bonus, Jump Ramps, Tickets Spent, etc)
* Light **[Wheel](#heading--chance)**
...
* Spot **[Carnival Lock](#heading--carnivalmb)**
* **[Gabby Gabby Mystery Hurry-Up](#heading--gabby)** (hit Gabby Gabby for 50,000 max value award)
* Advance **[Super X](#heading--superx)** (if active)
* Add **[Super Spinner](#heading--spinners)** Time (if Super Spinner is active)
* Add **[Super Jets](#heading--jets)** Time (if Super Jets is active)
* Add **[Gabby Gabby Frenzy](#heading--gabby)** Time (if Gabby Gabby Frenzy is active)
* Light **[Jump Ramp](#heading--duke)**
* **[Collect Bonus](#heading--bonus)**
* 2x Tickets (Ramp ticket collections are doubled for a certain amount of time)
* Light **[Rescue Forky](#heading--forky)**
...
* Making three **[skill shots](#heading--skillshots)**
* 8 **[Caboom Jump Ramp shots](#heading--duke)**
* **[Light Extra Ball](#heading--lighteb)** **[Wheel](#heading--chance)** award

### End-of-Ball Bonus: {#heading--bonus}
Bonus is comprised of:

- Switch hits
- 10 per **[ticket](#heading--carnivalmb)** used
- 100 per **[Caboom jump ramp](#heading--duke)** shot
- 100 per upper loop
- 100 per **[Gabby Gabby](#heading--gabby)** hit

All multiplied by the bonus multiplier, which advances through successful **[skill shots](#heading--skillshots)** (multiples of +5x), completing both outer inlanes (which cycle with the flippers; +1x), or from upper loop shots during **[Super Loops](#heading--loops)** (+1x each).

## Take A Chance Multiball (Mini-Wizard Mode): {#heading--chancemb}
Once all eight **[wheel](#heading--chance)** awards have been collected, the next shot to the scoop during single-ball play will start **Take A Chance Multiball**. During this 4-ball multiball, *all* the Take A Chance awards activate at the same time and the wheel constantly spins, lighting the shot corresponding to each award for a jackpot. Every jackpot collected lights a lock - the first two are collected at the lock-up, the third is scored at the left ramp, and the final ball must be locked in the Tiki Party playfield's Tiki God saucer within 30 seconds to score the Super Jackpot built up through switch hits. Each Super Jackpot scored increases the base jackpot value for the multiball, which resets when the mode ends.

## Meet Me At The Carousel (Wizard Mode): {#heading--wizard}
After **[all seven scenes](#heading--scenes)** have been qualified or completed, shoot the scoop to begin the 4-stage wizard mode, **Meet Me At The Carousel** - or shoot the ramps to change which wizard mode path to play. Scoring for the wizard mode is multiplied by +1x, up to 7x, for every scene that was completed before starting the wizard mode.
