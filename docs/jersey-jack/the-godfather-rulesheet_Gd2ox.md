---
title: "The Godfather Rulesheet"
discourse_topic_id: 8186
manufacturer: "Jersey Jack Pinball"
opdb_id: "Gd2ox"
source: https://tiltforums.com/t/the-godfather-rulesheet/8186
---
...
- [Family Select](#heading--families)
- [Skill Shots](#heading--skillshots)
- [Jobs](#heading--jobs)
  - [Award Modes](#heading--awards)
- [Multiball Modes](#heading--multiball)
  - [Compound Multiball](#heading--compound)
  - [Sicily Multiball](#heading--sicily)
  - [Turf War Multiball](#heading--turfwar)
  - [5 Families Multiball](#heading--five)
- [Other Scoring](#heading--other)
  - [Weapons & Playfield X](#heading--pfx)
  - [Shot X](#heading--shotx)
  - [Influence](#heading--influence)
  - [Favor Awards](#heading--favor)
  - [Mystery Awards](heading--mystery)
  - [Extra Balls](#heading--extraballs)
  - [End-of-Ball Bonus](#heading--bonus)
- [Baptism (Mini-Wizard Mode)](#heading--baptism)
- [Honor (Mini-Wizard Mode)](#heading--honor)
- [Kiss the Ring (Wizard Mode)](#heading--ring)
...
21. **MEGA HIDEOUT**: Shoot Hideout from Ramp Target from **Right** Flipper
     - Each **[Bonus X](#heading--bonus)** +4
     - 1,000,000 x 1
22. **MEGA LOOPS**: Shoot Upper Loop from Ramp Target from **Right** Flipper
     - Unlimited Skill Loops
     - 750,000 x 1+++

Each super skill shot can only be collected once. Collecting all 22 super skill shots or collecting 12 **[Rings](#heading--awards)** allows them all to be collected again, and each super skill shot adds +1x to the value for the next.

## Jobs: {#heading--jobs}
The main modes of *The Godfather* are jobs assigned to you by the Don. To start a new job, collect **soldiers** by making shots or hitting targets around the playfield - targets are worth 3 soldiers, shots are worth 2 soldiers, and slingshots are worth 1 soldier. The soldiers act as your "timer" during modes - up to 100 can be collected at once. Once enough soldiers have been collected, Don's Office will light to start the next job. Certain levels of **[influence](#heading--influence)** also light Don's Office to start jobs.

After shooting the required shots in each job, Don's Office will light for the cash out. Use the flipper buttons to continue the mode and keep increasing the value for cashing out, or press the action button to cash out and receive all of the mode completion benefits. The cash out value is impacted by the **[playfield](#heading--pfx)** and **[shot](#heading--shotx)** multipliers, though the multiplied value isn't displayed until it has been cashed out.

The **Job Modes**, listed clockwise from their appearance above the flippers, are:
- **Dinner Specials**: Shoot the loop ramp, then send the ball to the left inlane and shoot the bad guy to light the scoop. (*Cashing out during this mode makes jackpots easier to score during **[Compound Multiball](#heading--compound)***).
- **Take the Cannoli**: Shoot any two of the lit shots, then shoot the right inlane target followed by the bad guy to light the scoop. (*Cashing out during this mode adds a ball to **[Compound Multiball](#heading--compound)***).
- **Pursuit**: Shoot 2 lit shots while avoiding the flashing red / blue shots (the police), then shoot the hideout or compound target to light the office for the cash out. (*Cashing out during this mode makes it easier to qualify the super jackpot during **[Sicily Multiball](#heading--sicily)***).
- **Delivery**: Loop the left ramp twice to load the delivery, then shoot under it to make the delivery and light the office for the cash out. (*Cashing out during this mode adds a ball to **[Sicily Multiball](#heading--sicily)***).
- **Shakedown**: "Shoot everything" and score 20 switch hits, then shoot the compound target to light the office for the cash out. 20 more switch hits are required each time you continue. (*Cashing out during this mode adds a ball to **[Turf War Multiball](#heading--turfwar)***).
- **Market Day**: Shoot two of the roving shots, then shoot the bad guy. (*Cashing out during this mode makes it easier to relight jackpots during **[Turf War Multiball](#heading--turfwar)***).
- **Hung Jury**: Shoot either orbit or the hideout to track down the juror (+1 each time you continue), then shoot the office for the cash out. (*Cashing out during this mode makes all jackpots lit right away during **[5 Families Multiball](#heading--five)***).
- **Wedding Favor**: Roll through any of the VITO lanes twice or shoot behind the upper flipper to earn favors, then shoot Don's office to request the favor and enable the cash out on the next scoop shot. (*Cashing out during this mode adds a ball to **[5 Families Multiball](#heading--five)***).

Playing all eight **Job Modes** is required to qualify **[Honor](#heading--honor)**.

### Job Award Modes: {#heading--awards}
Playing through two **[jobs](#heading--jobs)** adjacent to the blue inserts on the stained glass window qualifies **Job Award** modes at Don's Office. These modes play similarly to normal jobs, but allow you to score Rings as you make shots. The final wizard mode, **[Kiss the Ring](#heading--ring)**, can only be lit after you've collected enough Rings from award modes.
...
Playing all four **Job Award** modes is required to qualify **[Honor](#heading--honor)**.

## Multiball Modes: {#heading--multiball}
The four multiball modes on *The Godfather* all tie into **[jobs](#heading--jobs)** and can be improved by successfully cashing them out before starting the multiball.  The four multiball modes can be stacked with each other for huge points, and progress can be made towards all of them even while other multiballs are running.

Playing all four multiball modes is required to qualify **[Honor](#heading--honor)**.
...
Defeating all eight bad guys - two from each crime family excluding your own - will qualify the **[Baptism](#heading--baptism)** mini-wizard mode in place of the multiball.

## Other Scoring: {#heading--other}
### Weapons & Playfield X: {#heading--pfx}
Shoot the spinners to upgrade the currently lit weapon, which can be used by pressing the action button and increased further by quickly pressing it again. Each weapon corresponds to a playfield multiplier, up to 10x playfield. The playfield X timer can be extended by pressing the action button while a weapon is already being used. The max playfield X value can be increased via **[influence](#heading--influence)** or by actively using the weapons, and starts at 4x.
...
- By default, **[ventures](#heading--turfwar)** are lit at the start of the game.
- Beat Cops - **[Soldiers](#heading--jobs)** remain active for longer.
- Detectives - More **[ventures](#heading--turfwar)** are lit. The next **[job](#heading--jobs)** is qualified.
- 4 - Max **[weapon](#heading--pfx)** level increased.
- 5 - **[Offer](#heading--mystery)** advanced.
- 6 - More **[ventures](#heading--turfwar)** are lit. **[Soldiers](#heading--jobs)** remain active for longer.
- Senator - The next **[job](#heading--jobs)** is qualified. **[Extra ball](#heading--extraballs)** is lit.
- Presidential - Max **[weapon](#heading--pfx)** level increased. **[Offer](#heading--mystery)** advanced.

Reaching the Presidential level of influence is required to qualify **[the final wizard mode](#heading--ring)**.

### Favor Awards: {#heading--favor}
Shooting Don's Office qualifies the right inlane target for a Favor award. Favor awards either "small points" (100k) or adds **soldiers** during a **[job](#heading--jobs)**.
...
- Cashing out 3 **[jobs](#heading--jobs)**
- Defeating 3 **[bad guys](#heading--five)**
- Reaching **[Senator](#heading--influence)**-level influence
...
## Baptism (Mini-Wizard Mode): {#heading--baptism}
After defeating all four level 2 **[bad guys](#heading--five)**, the next shot behind the center drop target will start the Baptism mode.

Starting Baptism is required to qualify **[the final wizard mode](#heading--ring)**.
...
- Playing all **[jobs](#heading--jobs)**
- Playing all **[award modes](#heading--awards)**
- Playing all four **[multiball modes](#heading--multiball)**

Starting Honor is required to qualify **[the final wizard mode](#heading--ring)**.

## Kiss the Ring (Wizard Mode): {#heading--ring}
To qualify the final wizard mode at Don's Office, the following tasks must be completed:

- Start **[Honor](#heading--honor)** mini-wizard mode
- Start **[Baptism](#heading--baptism)** mini-wizard mode
- Collect X rings from **[award modes](#heading--awards)**
- Gather all **[territories](#heading--turfwar)**
- Use a **[weapon](#heading--pfx)** at 10x playfield X
- Get to **[Presidential](#heading--influence)** influence level