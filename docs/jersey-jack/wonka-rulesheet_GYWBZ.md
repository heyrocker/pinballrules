---
title: "Wonka Rulesheet"
discourse_topic_id: 5406
manufacturer: "Jersey Jack Pinball"
opdb_id: "GYWBZ"
source: https://tiltforums.com/t/wonka-rulesheet/5406
---
...
- [Golden Tickets](#heading--tickets)
  ...
  - [Wonkavator Multiball & Super Locks](#heading--wonkavatormb)
  - [Gumball Machine](#heading--gumball)
  - [Wizard Modes](#heading--wizard)
- [Other Scoring](#heading--other)
  - [Wonka Bars & Ransom](#heading--bars)
  - [Computer Awards](#heading--computer)
  - [Captive Ball Mystery](#heading--mystery)
  - [Scrumdiddlyumptious Combo](#heading--combos)
  - [Standup Target Awards](#heading--targets)
...
- A soft plunge into the saucer awards points, 1 **[WONKA letter](#heading--tour)**, and increments the **[Candy Jar](#heading--spinner)** by 1.
- A soft plunge to the upper flipper followed by a shot up the center ramp scores points, lights the **[Computer Award](#heading--computer)**, and increments the **Candy Jar** by 5.
- **Super Skill Shot**: Hold the left flipper, soft plunge to the upper flipper, then shoot the center ramp followed by the saucer. This scores points, qualifies the **Computer Award**, increments *all* of the **Factory Tour** modes by +1 shot, increments the **Candy Jar** by 10, and increases the **[Bonus Multiplier](#heading--bonus)** by +1x. Just remember that plunging too far into the saucer or the side loop means *you get nothing!*
- **Super Secret Skill Shot**: Hold the left flipper and soft plunge to the upper right flipper. Then combo the upper/center ramp, the right ramp, the left ramp, and the TV saucer, in that order. This awards +2 Computer Award, +3 Factory Advance, +25 Candy Bar, +2 Bonus X, and 80,000 points ([Video at 21:45](https://youtu.be/UUU_FEVAIDs?si=v4OU6IE5YSFBBlYc)).
...
- **Blue Modes:** These are the typical timed modes, lit by shooting the right ramp to add letters to WONKA (3 letters are spotted at the start of the game, minus 1 for each blue mode played). WONKA letters can also be added through certain **[skill shots](#heading--skillshots)** or by rolling through the inner left inlane and shooting the factory target on a hurry-up timer, to instantly collect all WONKA letters. The lit mode can be changed by shooting the right ramp or factory target when one is lit, and time can be added during any mode by shooting the factory target after a shot has been made.
  ...
  - **Fizzy Lifting Drink Room:** Advance through the room by shooting the left ramp to complete the first level, then make shots to the spinner and bumpers to advance through further levels. Upon reaching level 5, the final shot will be a hurry-up at the Most Secret Machine. Start this mode to qualify **[Charlie](#heading--kidmb)**, and complete this mode to collect Charlie.
  - **Golden Egg Room:** Shoot the flashing green shots for good eggs, while avoiding the red shots which will award bad eggs and reduce the scoring for the mode. The final shot in this mode will be the Most Secret Machine (flashing both green and red) for the mode total. Start this mode to qualify **[Veruca](#heading--kidmb)**, and make the final shot to collect Veruca.
...
- **Orange Modes:** These are awards or other features that can only be collected by shooting the captive ball, then toggled with further shots to the captive ball.
  - **Super Spinner:** For 30 seconds, all spinner hits score a **[Wonka Bar](#heading--bars)**. Super Spinner can also be lit for a single spinner rip by shooting the left target followed by the spinner, even if Super Spinner isn't currently running.
  - **2x Wonka Bars:** For 30 seconds, all ramp shots (or other methods) collect two times the amount of **[Wonka Bars](#heading--bars)** they would otherwise.
  - **Collect Bonus:** Collects the current **[end-of-ball bonus](#heading--bonus)**, multiplied by the bonus X and any ongoing Super X.
...
- **Charlie**: Qualify Charlie by starting the **[Fizzy Lifting Drink Room](#heading--tour)** Factory Tour mode, and collect him by finishing said mode. Lights jackpots at the right ramp.
...
- **Veruca**: Veruca can be qualified by starting the **[Golden Egg Room](#heading--tour)** Factory Tour mode, and can be collected by finishing the mode. Lights jackpots at the left ramp.
...
- Starting one of each **[Factory Tour Mode](#heading--tour)** (1 lock)
- "Light Super Lock" **[Computer Award](#heading--computer)** (all 3 locks!)
- **[Captive Ball Mystery](#heading--mystery)** award (1 lock)
...
### Scrumdidilyumptious Combo: {#heading--combos}
...
- 3 target completions lights **[Extra Ball](#heading--extraballs)**
...
- 1st **[standup target award](#heading--targets)**
- "Light Extra Ball" **[Computer Award](#heading--computer)**
- "Light Extra Ball" **[Captive Ball Mystery](#heading--mystery)** award

### End-of-Ball Bonus: {#heading--bonus}
Bonus is simply calculated by awarding 500 points per Wonka Bar, times the Bonus Multiplier. The end-of-ball bonus can be scored during a ball, with any applicable multipliers, through the **[Collect Bonus](#heading--tour)** Factory Tour mode.